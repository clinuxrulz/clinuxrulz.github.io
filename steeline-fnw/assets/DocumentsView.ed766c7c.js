import{f as M,c as H,a as i,i as u,b as I,e as _,I as P,t as w,J as V}from"./index.561257c9.js";import{D as B}from"./DocumentView.d5ca8dec.js";const J=w('<div class="page"></div>'),O=w('<div style="flex-grow: 1; display: flex; flex-direction: row;"><div style="padding: 5px;"><b>Documents</b><ul class="list-group"></ul></div><div style="flex-grow: 1; display: flex; flex-direction: column; overflow: hidden;"><div style="display: flex; flex-direction: row;"><button class="btn btn-primary">Print</button><div style="flex-grow: 1; text-align: center"><button class="btn btn-primary">&lt;</button>Page <!> of <button class="btn btn-primary">></button></div></div></div></div>'),R=w('<li class="list-group-item" style="cursor: default;"></li>'),W=`body {
    width: 100%;
    height: 100%;
    margin: 0;
    padding: 0;
