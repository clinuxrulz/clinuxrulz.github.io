...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function oe(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function D(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(o){return Object.getOwnPropertyDescriptor(e,o).enumerable})),n.push.apply(n,r)}return n}function V(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?D(Object(n),!0).forEach(function(r){oe(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):D(Object(n)).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function ae(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return function(r){return t.reduceRight(function(o,a){return a(o)},r)}}function v(e){return function t(){for(var n=this,r=arguments.length,o=new Array(r),a=0;a<r;a++)o[a]=arguments[a];return o.length>=e.length?e.apply(this,o):function(){for(var c=arguments.length,s=new Array(c),i=0;i<c;i++)s[i]=arguments[i];return t.apply(n,[].concat(o,s))}}}function w(e){return{}.toString.call(e).includes("Object")}function ce(e){return!Object.keys(e).length}function A(e){return typeof e=="function"}function ie(e,t){return Object.prototype.hasOwnProperty.call(e,t)}function se(e,t){return w(t)||p("changeType"),Object.keys(t).some(function(n){return!ie(e,n)})&&p("changeField"),t}function le(e){A(e)||p("selectorType")}function pe(e){A(e)||w(e)||p("handlerType"),w(e)&&Object.values(e).some(function(t){return!A(t)})&&p("handlersType")}function ue(e){e||p("initialIsRequired"),w(e)||p("initialType"),ce(e)&&p("initialContent")}function me(e,t){throw new Error(e[t]||e.default)}var fe={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},p=v(me)(fe),E={changes:se,selector:le,handler:pe,initial:ue};function de(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};E.initial(e),E.handler(t);var n={current:e},r=v(he)(n,t),o=v(ge)(n),a=v(E.changes)(e),c=v(ye)(n);function s(){var l=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(u){return u};return E.selector(l),l(n.current)}function i(l){ae(r,o,a,c)(l)}return[s,i]}function ye(e,t){return A(t)?t(e.current):t}function ge(e,t){return e.current=V(V({},e.current),t),t}function he(e,t,n){return A(t)?t(e.current):Object.keys(n).forEach(function(r){var o;return(o=t[r])===null||o===void 0?void 0:o.call(t,e.current[r])}),n}var ve={create:de},Se={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.52.2/min/vs"}};function be(e){return function t(){for(var n=this,r=arguments.length,o=new Array(r),a=0;a<r;a++)o[a]=arguments[a];return o.length>=e.length?e.apply(this,o):function(){for(var c=arguments.length,s=new Array(c),i=0;i<c;i++)s[i]=arguments[i];return t.apply(n,[].concat(o,s))}}}function Ae(e){return{}.toString.call(e).includes("Object")}function Te(e){return e||W("configIsRequired"),Ae(e)||W("configType"),e.urls?(Ee(),{paths:{vs:e.urls.monacoBase}}):e}function Ee(){console.warn($.deprecation)}function je(e,t){throw new Error(e[t]||e.default)}var $={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},W=be(je)($),we={config:Te},Oe=function(){for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r];return function(o){return n.reduceRight(function(a,c){return c(a)},o)}};function N(e,t){return Object.keys(t).forEach(function(n){t[n]instanceof Object&&e[n]&&Object.assign(t[n],N(e[n],t[n]))}),F(F({},e),t)}var Ce={type:"cancelation",msg:"operation is manually canceled"};function C(e){var t=!1,n=new Promise(function(r,o){e.then(function(a){return t?o(Ce):r(a)}),e.catch(o)});return n.cancel=function(){return t=!0},n}var Ie=ve.create({config:Se,isInitialized:!1,resolve:null,reject:null,monaco:null}),L=Z(Ie,2),T=L[0],O=L[1];function xe(e){var t=we.config(e),n=t.monaco,r=X(t,["monaco"]);O(function(o){return{config:N(o.config,r),monaco:n}})}function Re(){var e=T(function(t){var n=t.monaco,r=t.isInitialized,o=t.resolve;return{monaco:n,isInitialized:r,resolve:o}});if(!e.isInitialized){if(O({isInitialized:!0}),e.monaco)return e.resolve(e.monaco),C(I);if(window.monaco&&window.monaco.editor)return k(window.monaco),e.resolve(window.monaco),C(I);Oe(Pe,Me)(De)}return C(I)}function Pe(e){return document.body.appendChild(e)}function Fe(e){var t=document.createElement("script");return e&&(t.src=e),t}function Me(e){var t=T(function(r){var o=r.config,a=r.reject;return{config:o,reject:a}}),n=Fe("".concat(t.config.paths.vs,"/loader.js"));return n.onload=function(){return e()},n.onerror=t.reject,n}function De(){var e=T(function(n){var r=n.config,o=n.resolve,a=n.reject;return{config:r,resolve:o,reject:a}}),t=window.require;t.config(e.config),t(["vs/editor/editor.main"],function(n){k(n),e.resolve(n)},function(n){e.reject(n)})}function k(e){T().monaco||O({monaco:e})}function Ve(){return T(function(e){var t=e.monaco;return t})}var I=new Promise(function(e,t){return O({resolve:e,reject:t})}),We={config:xe,init:Re,__getMonacoInstance:Ve};const $e=`import { SetStoreFunction, Store } from 'solid-js/store';
...
`,ke=`import { Accessor } from 'solid-js';
...
`,Je=`import { Result } from './kitty-demo/Result';
...
`;var Ue=H("<div>");const qe={"prelude/ecs/EcsComponent.d.ts":$e,"prelude/ecs/EcsRegistry.d.ts":Ne,"prelude/ecs/EcsWorld.d.ts":Le,"prelude/lib.d.ts":ke,"prelude/TypeSchema.d.ts":Je};let S=await We.init();const y=navigator&&/android/i.test(navigator.userAgent);let j=new U;function He(e){for(let[n,r]of Object.entries(qe)){let o=S.languages.typescript.typescriptDefaults.addExtraLib(r,n);x(()=>o.dispose())}S.languages.typescript.typescriptDefaults.setCompilerOptions({paths:{prelude:["./prelude/lib.js"]}});let t=(n,r,o)=>{f(K(()=>o.contents,a=>f(()=>{switch(a.type){case"File":{let c=a.id,s=n+a.name,i=r+a.name,l=o.openFileById(c);f(b(l,u=>{if(u.type!="Success")return;let m=u.value,g=S.editor.createModel(z(()=>m.doc.source),"typescript",S.Uri.parse(i));f(b(()=>m.doc.source,d=>{g.setValue(d)},{defer:!0}));let h={model:g,file:m};j.set(s,h),x(()=>{g.dispose(),j.get(s)===h&&j.delete(s)})}));break}case"Folder":{let c=a.id,s=o.openFolderById(c);f(b(s,i=>{if(i.type!="Success")return;let l=i.value;t(n+a.name+"/",r+a.name+"/",l)}));break}}})))};t("","file:///",e)}const Ke=e=>{let[t,n]=R(),[r,o]=R();return q(()=>{let a=t();if(a==null)return;let c=S.editor.create(a,{language:"typescript",quickSuggestions:{other:!y,comments:!y,strings:!y},automaticLayout:!0,acceptSuggestionOnCommitCharacter:!y,acceptSuggestionOnEnter:y?"off":"on",accessibilitySupport:y?"off":"on",theme:"vs-dark"});o(c);let s=_(()=>{if(e.path!=null)return j.get(e.path)});f(b(s,i=>{if(i==null)return;let l=i.model,u=i.file;c.setModel(l);let m=!1,g=()=>{if(m)return;let d=r()?.getModel()?.getValue();d!=null&&u.docHandle.change(J=>{G(J,["source"],d)})},h=l?.onDidChangeContent(g);x(()=>{h?.dispose()}),f(b(()=>u.doc.source,d=>{m=!0;try{l.setValue(d)}finally{m=!1}}))}))}),(()=>{var a=Ue(),c=n;return typeof c=="function"?B(c,a):n=a,a.style.setProperty("width","100%"),a.style.setProperty("height","100%"),a.style.setProperty("overflow","hidden"),a})()};export{Ke as default,He as mountAutomergeFolderToMonacoVfsWhileMounted};
