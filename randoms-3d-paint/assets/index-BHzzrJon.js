...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Bn,depthTest:!1,depthWrite:!1})}function qp(i,t,e){const n=new Float32Array(_i),s=new D(0,1,0);return new mn({name:"SphericalGaussianBlur",defines:{n:_i,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Nr(),fragmentShader:`
...
`)+`
`+d);const E=y+m+a,b=y+d+o,T=Xl(s,s.VERTEX_SHADER,E),C=Xl(s,s.FRAGMENT_SHADER,b);s.attachShader(M,T),s.attachShader(M,C),e.index0AttributeName!==void 0?s.bindAttribLocation(M,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function w(A){if(i.debug.checkShaderErrors){const I=s.getProgramInfoLog(M)||"",N=s.getShaderInfoLog(T)||"",z=s.getShaderInfoLog(C)||"",G=I.trim(),V=N.trim(),F=z.trim();let q=!0,J=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,T,C);else{const nt=ql(s,T,"vertex"),st=ql(s,C,"fragment");kt("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
}`,U_=[new D(1,0,0),new D(-1,0,0),new D(0,1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1)],N_=[new D(0,-1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1),new D(0,-1,0),new D(0,-1,0)],ec=new jt,cs=new D,xa=new D;function F_(i,t,e){let n=new zo;const s=new At,r=new At,a=new me,o=new qu,l=new ju,c={},f=e.maxTextureSize,u={[ii]:Ze,[Ze]:ii,[Sn]:Sn},h=new mn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new At},radius:{value:4}},vertexShader:I_,fragmentShader:L_}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const _=new Ue;_.setAttribute("position",new An(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new ft(_,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ar;let d=this.type;this.render=function(C,w,P){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;C.type===Bh&&(Pt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),C.type=ar);const g=i.getRenderTarget(),v=i.getActiveCubeFace(),A=i.getActiveMipmapLevel(),I=i.state;I.setBlending(Bn),I.buffers.depth.getReversed()===!0?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);const N=d!==this.type;N&&w.traverse(function(z){z.material&&(Array.isArray(z.material)?z.material.forEach(G=>G.needsUpdate=!0):z.material.needsUpdate=!0)});for(let z=0,G=C.length;z<G;z++){const V=C[z],F=V.shadow;if(F===void 0){Pt("WebGLShadowMap:",V,"has no shadow.");continue}if(F.autoUpdate===!1&&F.needsUpdate===!1)continue;s.copy(F.mapSize);const q=F.getFrameExtents();if(s.multiply(q),r.copy(F.mapSize),(s.x>f||s.y>f)&&(s.x>f&&(r.x=Math.floor(f/q.x),s.x=r.x*q.x,F.mapSize.x=r.x),s.y>f&&(r.y=Math.floor(f/q.y),s.y=r.y*q.y,F.mapSize.y=r.y)),F.map===null||N===!0){if(F.map!==null&&(F.map.depthTexture!==null&&(F.map.depthTexture.dispose(),F.map.depthTexture=null),F.map.dispose()),this.type===fs){if(V.isPointLight){Pt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}F.map=new Tn(s.x,s.y,{format:ji,type:Vn,minFilter:Le,magFilter:Le,generateMipmaps:!1}),F.map.texture.name=V.name+".shadowMap",F.map.depthTexture=new bs(s.x,s.y,yn),F.map.depthTexture.name=V.name+".shadowMapDepth",F.map.depthTexture.format=kn,F.map.depthTexture.compareFunction=null,F.map.depthTexture.minFilter=Re,F.map.depthTexture.magFilter=Re}else{V.isPointLight?(F.map=new Yc(s.x),F.map.depthTexture=new Xu(s.x,wn)):(F.map=new Tn(s.x,s.y),F.map.depthTexture=new bs(s.x,s.y,wn)),F.map.depthTexture.name=V.name+".shadowMap",F.map.depthTexture.format=kn;const nt=i.state.buffers.depth.getReversed();this.type===ar?(F.map.depthTexture.compareFunction=nt?Fo:No,F.map.depthTexture.minFilter=Le,F.map.depthTexture.magFilter=Le):(F.map.depthTexture.compareFunction=null,F.map.depthTexture.minFilter=Re,F.map.depthTexture.magFilter=Re)}F.camera.updateProjectionMatrix()}const J=F.map.isWebGLCubeRenderTarget?6:1;for(let nt=0;nt<J;nt++){if(F.map.isWebGLCubeRenderTarget)i.setRenderTarget(F.map,nt),i.clear();else{nt===0&&(i.setRenderTarget(F.map),i.clear());const st=F.getViewport(nt);a.set(r.x*st.x,r.y*st.y,r.x*st.z,r.y*st.w),I.viewport(a)}if(V.isPointLight){const st=F.camera,Rt=F.matrix,It=V.distance||st.far;It!==st.far&&(st.far=It,st.updateProjectionMatrix()),cs.setFromMatrixPosition(V.matrixWorld),st.position.copy(cs),xa.copy(st.position),xa.add(U_[nt]),st.up.copy(N_[nt]),st.lookAt(xa),st.updateMatrixWorld(),Rt.makeTranslation(-cs.x,-cs.y,-cs.z),ec.multiplyMatrices(st.projectionMatrix,st.matrixWorldInverse),F._frustum.setFromProjectionMatrix(ec,st.coordinateSystem,st.reversedDepth)}else F.updateMatrices(V);n=F.getFrustum(),b(w,P,F.camera,V,this.type)}F.isPointLightShadow!==!0&&this.type===fs&&y(F,P),F.needsUpdate=!1}d=this.type,m.needsUpdate=!1,i.setRenderTarget(g,v,A)};function y(C,w){const P=t.update(M);h.defines.VSM_SAMPLES!==C.blurSamples&&(h.defines.VSM_SAMPLES=C.blurSamples,p.defines.VSM_SAMPLES=C.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Tn(s.x,s.y,{format:ji,type:Vn})),h.uniforms.shadow_pass.value=C.map.depthTexture,h.uniforms.resolution.value=C.mapSize,h.uniforms.radius.value=C.radius,i.setRenderTarget(C.mapPass),i.clear(),i.renderBufferDirect(w,null,P,h,M,null),p.uniforms.shadow_pass.value=C.mapPass.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,i.setRenderTarget(C.map),i.clear(),i.renderBufferDirect(w,null,P,p,M,null)}function E(C,w,P,g){let v=null;const A=P.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(A!==void 0)v=A;else if(v=P.isPointLight===!0?l:o,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const I=v.uuid,N=w.uuid;let z=c[I];z===void 0&&(z={},c[I]=z);let G=z[N];G===void 0&&(G=v.clone(),z[N]=G,w.addEventListener("dispose",T)),v=G}if(v.visible=w.visible,v.wireframe=w.wireframe,g===fs?v.side=w.shadowSide!==null?w.shadowSide:w.side:v.side=w.shadowSide!==null?w.shadowSide:u[w.side],v.alphaMap=w.alphaMap,v.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,v.map=w.map,v.clipShadows=w.clipShadows,v.clippingPlanes=w.clippingPlanes,v.clipIntersection=w.clipIntersection,v.displacementMap=w.displacementMap,v.displacementScale=w.displacementScale,v.displacementBias=w.displacementBias,v.wireframeLinewidth=w.wireframeLinewidth,v.linewidth=w.linewidth,P.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const I=i.properties.get(v);I.light=P}return v}function b(C,w,P,g,v){if(C.visible===!1)return;if(C.layers.test(w.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&v===fs)&&(!C.frustumCulled||n.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,C.matrixWorld);const N=t.update(C),z=C.material;if(Array.isArray(z)){const G=N.groups;for(let V=0,F=G.length;V<F;V++){const q=G[V],J=z[q.materialIndex];if(J&&J.visible){const nt=E(C,J,g,v);C.onBeforeShadow(i,C,w,P,N,nt,q),i.renderBufferDirect(P,null,N,nt,C,q),C.onAfterShadow(i,C,w,P,N,nt,q)}}}else if(z.visible){const G=E(C,z,g,v);C.onBeforeShadow(i,C,w,P,N,G,null),i.renderBufferDirect(P,null,N,G,C,null),C.onAfterShadow(i,C,w,P,N,G,null)}}const I=C.children;for(let N=0,z=I.length;N<z;N++)b(I[N],w,P,g,v)}function T(C){C.target.removeEventListener("dispose",T);for(const P in c){const g=c[P],v=C.target.uuid;v in g&&(g[v].dispose(),delete g[v])}}}const O_={[Pa]:Da,[Ia]:Na,[La]:Fa,[Yi]:Ua,[Da]:Pa,[Na]:Ia,[Fa]:La,[Ua]:Yi};function B_(i,t){function e(){let U=!1;const ut=new me;let et=null;const dt=new me(0,0,0,0);return{setMask:function(Q){et!==Q&&!U&&(i.colorMask(Q,Q,Q,Q),et=Q)},setLocked:function(Q){U=Q},setClear:function(Q,$,it,Dt,le){le===!0&&(Q*=Dt,$*=Dt,it*=Dt),ut.set(Q,$,it,Dt),dt.equals(ut)===!1&&(i.clearColor(Q,$,it,Dt),dt.copy(ut))},reset:function(){U=!1,et=null,dt.set(-1,0,0,0)}}}function n(){let U=!1,ut=!1,et=null,dt=null,Q=null;return{setReversed:function($){if(ut!==$){const it=t.get("EXT_clip_control");$?it.clipControlEXT(it.LOWER_LEFT_EXT,it.ZERO_TO_ONE_EXT):it.clipControlEXT(it.LOWER_LEFT_EXT,it.NEGATIVE_ONE_TO_ONE_EXT),ut=$;const Dt=Q;Q=null,this.setClear(Dt)}},getReversed:function(){return ut},setTest:function($){$?K(i.DEPTH_TEST):mt(i.DEPTH_TEST)},setMask:function($){et!==$&&!U&&(i.depthMask($),et=$)},setFunc:function($){if(ut&&($=O_[$]),dt!==$){switch($){case Pa:i.depthFunc(i.NEVER);break;case Da:i.depthFunc(i.ALWAYS);break;case Ia:i.depthFunc(i.LESS);break;case Yi:i.depthFunc(i.LEQUAL);break;case La:i.depthFunc(i.EQUAL);break;case Ua:i.depthFunc(i.GEQUAL);break;case Na:i.depthFunc(i.GREATER);break;case Fa:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}dt=$}},setLocked:function($){U=$},setClear:function($){Q!==$&&(ut&&($=1-$),i.clearDepth($),Q=$)},reset:function(){U=!1,et=null,dt=null,Q=null,ut=!1}}}function s(){let U=!1,ut=null,et=null,dt=null,Q=null,$=null,it=null,Dt=null,le=null;return{setTest:function(Zt){U||(Zt?K(i.STENCIL_TEST):mt(i.STENCIL_TEST))},setMask:function(Zt){ut!==Zt&&!U&&(i.stencilMask(Zt),ut=Zt)},setFunc:function(Zt,gn,Rn){(et!==Zt||dt!==gn||Q!==Rn)&&(i.stencilFunc(Zt,gn,Rn),et=Zt,dt=gn,Q=Rn)},setOp:function(Zt,gn,Rn){($!==Zt||it!==gn||Dt!==Rn)&&(i.stencilOp(Zt,gn,Rn),$=Zt,it=gn,Dt=Rn)},setLocked:function(Zt){U=Zt},setClear:function(Zt){le!==Zt&&(i.clearStencil(Zt),le=Zt)},reset:function(){U=!1,ut=null,et=null,dt=null,Q=null,$=null,it=null,Dt=null,le=null}}}const r=new e,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let f={},u={},h=new WeakMap,p=[],_=null,M=!1,m=null,d=null,y=null,E=null,b=null,T=null,C=null,w=new Xt(0,0,0),P=0,g=!1,v=null,A=null,I=null,N=null,z=null;const G=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let V=!1,F=0;const q=i.getParameter(i.VERSION);q.indexOf("WebGL")!==-1?(F=parseFloat(/^WebGL (\d)/.exec(q)[1]),V=F>=1):q.indexOf("OpenGL ES")!==-1&&(F=parseFloat(/^OpenGL ES (\d)/.exec(q)[1]),V=F>=2);let J=null,nt={};const st=i.getParameter(i.SCISSOR_BOX),Rt=i.getParameter(i.VIEWPORT),It=new me().fromArray(st),ae=new me().fromArray(Rt);function ue(U,ut,et,dt){const Q=new Uint8Array(4),$=i.createTexture();i.bindTexture(U,$),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let it=0;it<et;it++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(ut,0,i.RGBA,1,1,dt,0,i.RGBA,i.UNSIGNED_BYTE,Q):i.texImage2D(ut+it,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Q);return $}const j={};j[i.TEXTURE_2D]=ue(i.TEXTURE_2D,i.TEXTURE_2D,1),j[i.TEXTURE_CUBE_MAP]=ue(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),j[i.TEXTURE_2D_ARRAY]=ue(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),j[i.TEXTURE_3D]=ue(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),K(i.DEPTH_TEST),a.setFunc(Yi),Ft(!1),Se(tl),K(i.CULL_FACE),$t(Bn);function K(U){f[U]!==!0&&(i.enable(U),f[U]=!0)}function mt(U){f[U]!==!1&&(i.disable(U),f[U]=!1)}function Lt(U,ut){return u[U]!==ut?(i.bindFramebuffer(U,ut),u[U]=ut,U===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=ut),U===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=ut),!0):!1}function xt(U,ut){let et=p,dt=!1;if(U){et=h.get(ut),et===void 0&&(et=[],h.set(ut,et));const Q=U.textures;if(et.length!==Q.length||et[0]!==i.COLOR_ATTACHMENT0){for(let $=0,it=Q.length;$<it;$++)et[$]=i.COLOR_ATTACHMENT0+$;et.length=Q.length,dt=!0}}else et[0]!==i.BACK&&(et[0]=i.BACK,dt=!0);dt&&i.drawBuffers(et)}function Ht(U){return _!==U?(i.useProgram(U),_=U,!0):!1}const De={[pi]:i.FUNC_ADD,[Vh]:i.FUNC_SUBTRACT,[kh]:i.FUNC_REVERSE_SUBTRACT};De[Gh]=i.MIN,De[Hh]=i.MAX;const Vt={[Wh]:i.ZERO,[Xh]:i.ONE,[Yh]:i.SRC_COLOR,[Ra]:i.SRC_ALPHA,[Jh]:i.SRC_ALPHA_SATURATE,[Zh]:i.DST_COLOR,[jh]:i.DST_ALPHA,[qh]:i.ONE_MINUS_SRC_COLOR,[Ca]:i.ONE_MINUS_SRC_ALPHA,[Kh]:i.ONE_MINUS_DST_COLOR,[$h]:i.ONE_MINUS_DST_ALPHA,[Qh]:i.CONSTANT_COLOR,[tu]:i.ONE_MINUS_CONSTANT_COLOR,[eu]:i.CONSTANT_ALPHA,[nu]:i.ONE_MINUS_CONSTANT_ALPHA};function $t(U,ut,et,dt,Q,$,it,Dt,le,Zt){if(U===Bn){M===!0&&(mt(i.BLEND),M=!1);return}if(M===!1&&(K(i.BLEND),M=!0),U!==zh){if(U!==m||Zt!==g){if((d!==pi||b!==pi)&&(i.blendEquation(i.FUNC_ADD),d=pi,b=pi),Zt)switch(U){case Hi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case el:i.blendFunc(i.ONE,i.ONE);break;case nl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case il:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:kt("WebGLState: Invalid blending: ",U);break}else switch(U){case Hi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case el:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case nl:kt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case il:kt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:kt("WebGLState: Invalid blending: ",U);break}y=null,E=null,T=null,C=null,w.set(0,0,0),P=0,m=U,g=Zt}return}Q=Q||ut,$=$||et,it=it||dt,(ut!==d||Q!==b)&&(i.blendEquationSeparate(De[ut],De[Q]),d=ut,b=Q),(et!==y||dt!==E||$!==T||it!==C)&&(i.blendFuncSeparate(Vt[et],Vt[dt],Vt[$],Vt[it]),y=et,E=dt,T=$,C=it),(Dt.equals(w)===!1||le!==P)&&(i.blendColor(Dt.r,Dt.g,Dt.b,le),w.copy(Dt),P=le),m=U,g=!1}function ie(U,ut){U.side===Sn?mt(i.CULL_FACE):K(i.CULL_FACE);let et=U.side===Ze;ut&&(et=!et),Ft(et),U.blending===Hi&&U.transparent===!1?$t(Bn):$t(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),a.setFunc(U.depthFunc),a.setTest(U.depthTest),a.setMask(U.depthWrite),r.setMask(U.colorWrite);const dt=U.stencilWrite;o.setTest(dt),dt&&(o.setMask(U.stencilWriteMask),o.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),o.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),ye(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?K(i.SAMPLE_ALPHA_TO_COVERAGE):mt(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ft(U){v!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),v=U)}function Se(U){U!==Fh?(K(i.CULL_FACE),U!==A&&(U===tl?i.cullFace(i.BACK):U===Oh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):mt(i.CULL_FACE),A=U}function L(U){U!==I&&(V&&i.lineWidth(U),I=U)}function ye(U,ut,et){U?(K(i.POLYGON_OFFSET_FILL),(N!==ut||z!==et)&&(i.polygonOffset(ut,et),N=ut,z=et)):mt(i.POLYGON_OFFSET_FILL)}function qt(U){U?K(i.SCISSOR_TEST):mt(i.SCISSOR_TEST)}function oe(U){U===void 0&&(U=i.TEXTURE0+G-1),J!==U&&(i.activeTexture(U),J=U)}function Mt(U,ut,et){et===void 0&&(J===null?et=i.TEXTURE0+G-1:et=J);let dt=nt[et];dt===void 0&&(dt={type:void 0,texture:void 0},nt[et]=dt),(dt.type!==U||dt.texture!==ut)&&(J!==et&&(i.activeTexture(et),J=et),i.bindTexture(U,ut||j[U]),dt.type=U,dt.texture=ut)}function R(){const U=nt[J];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function x(){try{i.compressedTexImage2D(...arguments)}catch(U){kt("WebGLState:",U)}}function O(){try{i.compressedTexImage3D(...arguments)}catch(U){kt("WebGLState:",U)}}function Y(){try{i.texSubImage2D(...arguments)}catch(U){kt("WebGLState:",U)}}function Z(){try{i.texSubImage3D(...arguments)}catch(U){kt("WebGLState:",U)}}function X(){try{i.compressedTexSubImage2D(...arguments)}catch(U){kt("WebGLState:",U)}}function yt(){try{i.compressedTexSubImage3D(...arguments)}catch(U){kt("WebGLState:",U)}}function rt(){try{i.texStorage2D(...arguments)}catch(U){kt("WebGLState:",U)}}function vt(){try{i.texStorage3D(...arguments)}catch(U){kt("WebGLState:",U)}}function Ct(){try{i.texImage2D(...arguments)}catch(U){kt("WebGLState:",U)}}function tt(){try{i.texImage3D(...arguments)}catch(U){kt("WebGLState:",U)}}function ot(U){It.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),It.copy(U))}function gt(U){ae.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),ae.copy(U))}function St(U,ut){let et=c.get(ut);et===void 0&&(et=new WeakMap,c.set(ut,et));let dt=et.get(U);dt===void 0&&(dt=i.getUniformBlockIndex(ut,U.name),et.set(U,dt))}function at(U,ut){const dt=c.get(ut).get(U);l.get(ut)!==dt&&(i.uniformBlockBinding(ut,dt,U.__bindingPointIndex),l.set(ut,dt))}function Ot(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),f={},J=null,nt={},u={},h=new WeakMap,p=[],_=null,M=!1,m=null,d=null,y=null,E=null,b=null,T=null,C=null,w=new Xt(0,0,0),P=0,g=!1,v=null,A=null,I=null,N=null,z=null,It.set(0,0,i.canvas.width,i.canvas.height),ae.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:K,disable:mt,bindFramebuffer:Lt,drawBuffers:xt,useProgram:Ht,setBlending:$t,setMaterial:ie,setFlipSided:Ft,setCullFace:Se,setLineWidth:L,setPolygonOffset:ye,setScissorTest:qt,activeTexture:oe,bindTexture:Mt,unbindTexture:R,compressedTexImage2D:x,compressedTexImage3D:O,texImage2D:Ct,texImage3D:tt,updateUBOMapping:St,uniformBlockBinding:at,texStorage2D:rt,texStorage3D:vt,texSubImage2D:Y,texSubImage3D:Z,compressedTexSubImage2D:X,compressedTexSubImage3D:yt,scissor:ot,viewport:gt,reset:Ot}}function z_(i,t,e,n,s,r,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new At,f=new WeakMap;let u;const h=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(R,x){return p?new OffscreenCanvas(R,x):yr("canvas")}function M(R,x,O){let Y=1;const Z=Mt(R);if((Z.width>O||Z.height>O)&&(Y=O/Math.max(Z.width,Z.height)),Y<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){const X=Math.floor(Y*Z.width),yt=Math.floor(Y*Z.height);u===void 0&&(u=_(X,yt));const rt=x?_(X,yt):u;return rt.width=X,rt.height=yt,rt.getContext("2d").drawImage(R,0,0,X,yt),Pt("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+X+"x"+yt+")."),rt}else return"data"in R&&Pt("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),R;return R}function m(R){return R.generateMipmaps}function d(R){i.generateMipmap(R)}function y(R){return R.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?i.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function E(R,x,O,Y,Z=!1){if(R!==null){if(i[R]!==void 0)return i[R];Pt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let X=x;if(x===i.RED&&(O===i.FLOAT&&(X=i.R32F),O===i.HALF_FLOAT&&(X=i.R16F),O===i.UNSIGNED_BYTE&&(X=i.R8)),x===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(X=i.R8UI),O===i.UNSIGNED_SHORT&&(X=i.R16UI),O===i.UNSIGNED_INT&&(X=i.R32UI),O===i.BYTE&&(X=i.R8I),O===i.SHORT&&(X=i.R16I),O===i.INT&&(X=i.R32I)),x===i.RG&&(O===i.FLOAT&&(X=i.RG32F),O===i.HALF_FLOAT&&(X=i.RG16F),O===i.UNSIGNED_BYTE&&(X=i.RG8)),x===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&(X=i.RG8UI),O===i.UNSIGNED_SHORT&&(X=i.RG16UI),O===i.UNSIGNED_INT&&(X=i.RG32UI),O===i.BYTE&&(X=i.RG8I),O===i.SHORT&&(X=i.RG16I),O===i.INT&&(X=i.RG32I)),x===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&(X=i.RGB8UI),O===i.UNSIGNED_SHORT&&(X=i.RGB16UI),O===i.UNSIGNED_INT&&(X=i.RGB32UI),O===i.BYTE&&(X=i.RGB8I),O===i.SHORT&&(X=i.RGB16I),O===i.INT&&(X=i.RGB32I)),x===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&(X=i.RGBA8UI),O===i.UNSIGNED_SHORT&&(X=i.RGBA16UI),O===i.UNSIGNED_INT&&(X=i.RGBA32UI),O===i.BYTE&&(X=i.RGBA8I),O===i.SHORT&&(X=i.RGBA16I),O===i.INT&&(X=i.RGBA32I)),x===i.RGB&&(O===i.UNSIGNED_INT_5_9_9_9_REV&&(X=i.RGB9_E5),O===i.UNSIGNED_INT_10F_11F_11F_REV&&(X=i.R11F_G11F_B10F)),x===i.RGBA){const yt=Z?Mr:Gt.getTransfer(Y);O===i.FLOAT&&(X=i.RGBA32F),O===i.HALF_FLOAT&&(X=i.RGBA16F),O===i.UNSIGNED_BYTE&&(X=yt===Jt?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT_4_4_4_4&&(X=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(X=i.RGB5_A1)}return(X===i.R16F||X===i.R32F||X===i.RG16F||X===i.RG32F||X===i.RGBA16F||X===i.RGBA32F)&&t.get("EXT_color_buffer_float"),X}function b(R,x){let O;return R?x===null||x===wn||x===ys?O=i.DEPTH24_STENCIL8:x===yn?O=i.DEPTH32F_STENCIL8:x===Ss&&(O=i.DEPTH24_STENCIL8,Pt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===wn||x===ys?O=i.DEPTH_COMPONENT24:x===yn?O=i.DEPTH_COMPONENT32F:x===Ss&&(O=i.DEPTH_COMPONENT16),O}function T(R,x){return m(R)===!0||R.isFramebufferTexture&&R.minFilter!==Re&&R.minFilter!==Le?Math.log2(Math.max(x.width,x.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?x.mipmaps.length:1}function C(R){const x=R.target;x.removeEventListener("dispose",C),P(x),x.isVideoTexture&&f.delete(x)}function w(R){const x=R.target;x.removeEventListener("dispose",w),v(x)}function P(R){const x=n.get(R);if(x.__webglInit===void 0)return;const O=R.source,Y=h.get(O);if(Y){const Z=Y[x.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&g(R),Object.keys(Y).length===0&&h.delete(O)}n.remove(R)}function g(R){const x=n.get(R);i.deleteTexture(x.__webglTexture);const O=R.source,Y=h.get(O);delete Y[x.__cacheKey],a.memory.textures--}function v(R){const x=n.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),n.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(x.__webglFramebuffer[Y]))for(let Z=0;Z<x.__webglFramebuffer[Y].length;Z++)i.deleteFramebuffer(x.__webglFramebuffer[Y][Z]);else i.deleteFramebuffer(x.__webglFramebuffer[Y]);x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer[Y])}else{if(Array.isArray(x.__webglFramebuffer))for(let Y=0;Y<x.__webglFramebuffer.length;Y++)i.deleteFramebuffer(x.__webglFramebuffer[Y]);else i.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&i.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let Y=0;Y<x.__webglColorRenderbuffer.length;Y++)x.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(x.__webglColorRenderbuffer[Y]);x.__webglDepthRenderbuffer&&i.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const O=R.textures;for(let Y=0,Z=O.length;Y<Z;Y++){const X=n.get(O[Y]);X.__webglTexture&&(i.deleteTexture(X.__webglTexture),a.memory.textures--),n.remove(O[Y])}n.remove(R)}let A=0;function I(){A=0}function N(){const R=A;return R>=s.maxTextures&&Pt("WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+s.maxTextures),A+=1,R}function z(R){const x=[];return x.push(R.wrapS),x.push(R.wrapT),x.push(R.wrapR||0),x.push(R.magFilter),x.push(R.minFilter),x.push(R.anisotropy),x.push(R.internalFormat),x.push(R.format),x.push(R.type),x.push(R.generateMipmaps),x.push(R.premultiplyAlpha),x.push(R.flipY),x.push(R.unpackAlignment),x.push(R.colorSpace),x.join()}function G(R,x){const O=n.get(R);if(R.isVideoTexture&&qt(R),R.isRenderTargetTexture===!1&&R.isExternalTexture!==!0&&R.version>0&&O.__version!==R.version){const Y=R.image;if(Y===null)Pt("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)Pt("WebGLRenderer: Texture marked for update but image is incomplete");else{j(O,R,x);return}}else R.isExternalTexture&&(O.__webglTexture=R.sourceTexture?R.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+x)}function V(R,x){const O=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&O.__version!==R.version){j(O,R,x);return}else R.isExternalTexture&&(O.__webglTexture=R.sourceTexture?R.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+x)}function F(R,x){const O=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&O.__version!==R.version){j(O,R,x);return}e.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+x)}function q(R,x){const O=n.get(R);if(R.isCubeDepthTexture!==!0&&R.version>0&&O.__version!==R.version){K(O,R,x);return}e.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+x)}const J={[za]:i.REPEAT,[Ge]:i.CLAMP_TO_EDGE,[Va]:i.MIRRORED_REPEAT},nt={[Re]:i.NEAREST,[ru]:i.NEAREST_MIPMAP_NEAREST,[Ls]:i.NEAREST_MIPMAP_LINEAR,[Le]:i.LINEAR,[kr]:i.LINEAR_MIPMAP_NEAREST,[gi]:i.LINEAR_MIPMAP_LINEAR},st={[lu]:i.NEVER,[du]:i.ALWAYS,[cu]:i.LESS,[No]:i.LEQUAL,[hu]:i.EQUAL,[Fo]:i.GEQUAL,[uu]:i.GREATER,[fu]:i.NOTEQUAL};function Rt(R,x){if(x.type===yn&&t.has("OES_texture_float_linear")===!1&&(x.magFilter===Le||x.magFilter===kr||x.magFilter===Ls||x.magFilter===gi||x.minFilter===Le||x.minFilter===kr||x.minFilter===Ls||x.minFilter===gi)&&Pt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(R,i.TEXTURE_WRAP_S,J[x.wrapS]),i.texParameteri(R,i.TEXTURE_WRAP_T,J[x.wrapT]),(R===i.TEXTURE_3D||R===i.TEXTURE_2D_ARRAY)&&i.texParameteri(R,i.TEXTURE_WRAP_R,J[x.wrapR]),i.texParameteri(R,i.TEXTURE_MAG_FILTER,nt[x.magFilter]),i.texParameteri(R,i.TEXTURE_MIN_FILTER,nt[x.minFilter]),x.compareFunction&&(i.texParameteri(R,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(R,i.TEXTURE_COMPARE_FUNC,st[x.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===Re||x.minFilter!==Ls&&x.minFilter!==gi||x.type===yn&&t.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){const O=t.get("EXT_texture_filter_anisotropic");i.texParameterf(R,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,s.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function It(R,x){let O=!1;R.__webglInit===void 0&&(R.__webglInit=!0,x.addEventListener("dispose",C));const Y=x.source;let Z=h.get(Y);Z===void 0&&(Z={},h.set(Y,Z));const X=z(x);if(X!==R.__cacheKey){Z[X]===void 0&&(Z[X]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,O=!0),Z[X].usedTimes++;const yt=Z[R.__cacheKey];yt!==void 0&&(Z[R.__cacheKey].usedTimes--,yt.usedTimes===0&&g(x)),R.__cacheKey=X,R.__webglTexture=Z[X].texture}return O}function ae(R,x,O){return Math.floor(Math.floor(R/O)/x)}function ue(R,x,O,Y){const X=R.updateRanges;if(X.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,x.width,x.height,O,Y,x.data);else{X.sort((tt,ot)=>tt.start-ot.start);let yt=0;for(let tt=1;tt<X.length;tt++){const ot=X[yt],gt=X[tt],St=ot.start+ot.count,at=ae(gt.start,x.width,4),Ot=ae(ot.start,x.width,4);gt.start<=St+1&&at===Ot&&ae(gt.start+gt.count-1,x.width,4)===at?ot.count=Math.max(ot.count,gt.start+gt.count-ot.start):(++yt,X[yt]=gt)}X.length=yt+1;const rt=i.getParameter(i.UNPACK_ROW_LENGTH),vt=i.getParameter(i.UNPACK_SKIP_PIXELS),Ct=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,x.width);for(let tt=0,ot=X.length;tt<ot;tt++){const gt=X[tt],St=Math.floor(gt.start/4),at=Math.ceil(gt.count/4),Ot=St%x.width,U=Math.floor(St/x.width),ut=at,et=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ot),i.pixelStorei(i.UNPACK_SKIP_ROWS,U),e.texSubImage2D(i.TEXTURE_2D,0,Ot,U,ut,et,O,Y,x.data)}R.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,rt),i.pixelStorei(i.UNPACK_SKIP_PIXELS,vt),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ct)}}function j(R,x,O){let Y=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&(Y=i.TEXTURE_3D);const Z=It(R,x),X=x.source;e.bindTexture(Y,R.__webglTexture,i.TEXTURE0+O);const yt=n.get(X);if(X.version!==yt.__version||Z===!0){e.activeTexture(i.TEXTURE0+O);const rt=Gt.getPrimaries(Gt.workingColorSpace),vt=x.colorSpace===Jn?null:Gt.getPrimaries(x.colorSpace),Ct=x.colorSpace===Jn||rt===vt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ct);let tt=M(x.image,!1,s.maxTextureSize);tt=oe(x,tt);const ot=r.convert(x.format,x.colorSpace),gt=r.convert(x.type);let St=E(x.internalFormat,ot,gt,x.colorSpace,x.isVideoTexture);Rt(Y,x);let at;const Ot=x.mipmaps,U=x.isVideoTexture!==!0,ut=yt.__version===void 0||Z===!0,et=X.dataReady,dt=T(x,tt);if(x.isDepthTexture)St=b(x.format===xi,x.type),ut&&(U?e.texStorage2D(i.TEXTURE_2D,1,St,tt.width,tt.height):e.texImage2D(i.TEXTURE_2D,0,St,tt.width,tt.height,0,ot,gt,null));else if(x.isDataTexture)if(Ot.length>0){U&&ut&&e.texStorage2D(i.TEXTURE_2D,dt,St,Ot[0].width,Ot[0].height);for(let Q=0,$=Ot.length;Q<$;Q++)at=Ot[Q],U?et&&e.texSubImage2D(i.TEXTURE_2D,Q,0,0,at.width,at.height,ot,gt,at.data):e.texImage2D(i.TEXTURE_2D,Q,St,at.width,at.height,0,ot,gt,at.data);x.generateMipmaps=!1}else U?(ut&&e.texStorage2D(i.TEXTURE_2D,dt,St,tt.width,tt.height),et&&ue(x,tt,ot,gt)):e.texImage2D(i.TEXTURE_2D,0,St,tt.width,tt.height,0,ot,gt,tt.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){U&&ut&&e.texStorage3D(i.TEXTURE_2D_ARRAY,dt,St,Ot[0].width,Ot[0].height,tt.depth);for(let Q=0,$=Ot.length;Q<$;Q++)if(at=Ot[Q],x.format!==on)if(ot!==null)if(U){if(et)if(x.layerUpdates.size>0){const it=Il(at.width,at.height,x.format,x.type);for(const Dt of x.layerUpdates){const le=at.data.subarray(Dt*it/at.data.BYTES_PER_ELEMENT,(Dt+1)*it/at.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,Dt,at.width,at.height,1,ot,le)}x.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,at.width,at.height,tt.depth,ot,at.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Q,St,at.width,at.height,tt.depth,0,at.data,0,0);else Pt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else U?et&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,at.width,at.height,tt.depth,ot,gt,at.data):e.texImage3D(i.TEXTURE_2D_ARRAY,Q,St,at.width,at.height,tt.depth,0,ot,gt,at.data)}else{U&&ut&&e.texStorage2D(i.TEXTURE_2D,dt,St,Ot[0].width,Ot[0].height);for(let Q=0,$=Ot.length;Q<$;Q++)at=Ot[Q],x.format!==on?ot!==null?U?et&&e.compressedTexSubImage2D(i.TEXTURE_2D,Q,0,0,at.width,at.height,ot,at.data):e.compressedTexImage2D(i.TEXTURE_2D,Q,St,at.width,at.height,0,at.data):Pt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?et&&e.texSubImage2D(i.TEXTURE_2D,Q,0,0,at.width,at.height,ot,gt,at.data):e.texImage2D(i.TEXTURE_2D,Q,St,at.width,at.height,0,ot,gt,at.data)}else if(x.isDataArrayTexture)if(U){if(ut&&e.texStorage3D(i.TEXTURE_2D_ARRAY,dt,St,tt.width,tt.height,tt.depth),et)if(x.layerUpdates.size>0){const Q=Il(tt.width,tt.height,x.format,x.type);for(const $ of x.layerUpdates){const it=tt.data.subarray($*Q/tt.data.BYTES_PER_ELEMENT,($+1)*Q/tt.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,$,tt.width,tt.height,1,ot,gt,it)}x.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,tt.width,tt.height,tt.depth,ot,gt,tt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,St,tt.width,tt.height,tt.depth,0,ot,gt,tt.data);else if(x.isData3DTexture)U?(ut&&e.texStorage3D(i.TEXTURE_3D,dt,St,tt.width,tt.height,tt.depth),et&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,tt.width,tt.height,tt.depth,ot,gt,tt.data)):e.texImage3D(i.TEXTURE_3D,0,St,tt.width,tt.height,tt.depth,0,ot,gt,tt.data);else if(x.isFramebufferTexture){if(ut)if(U)e.texStorage2D(i.TEXTURE_2D,dt,St,tt.width,tt.height);else{let Q=tt.width,$=tt.height;for(let it=0;it<dt;it++)e.texImage2D(i.TEXTURE_2D,it,St,Q,$,0,ot,gt,null),Q>>=1,$>>=1}}else if(Ot.length>0){if(U&&ut){const Q=Mt(Ot[0]);e.texStorage2D(i.TEXTURE_2D,dt,St,Q.width,Q.height)}for(let Q=0,$=Ot.length;Q<$;Q++)at=Ot[Q],U?et&&e.texSubImage2D(i.TEXTURE_2D,Q,0,0,ot,gt,at):e.texImage2D(i.TEXTURE_2D,Q,St,ot,gt,at);x.generateMipmaps=!1}else if(U){if(ut){const Q=Mt(tt);e.texStorage2D(i.TEXTURE_2D,dt,St,Q.width,Q.height)}et&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,ot,gt,tt)}else e.texImage2D(i.TEXTURE_2D,0,St,ot,gt,tt);m(x)&&d(Y),yt.__version=X.version,x.onUpdate&&x.onUpdate(x)}R.__version=x.version}function K(R,x,O){if(x.image.length!==6)return;const Y=It(R,x),Z=x.source;e.bindTexture(i.TEXTURE_CUBE_MAP,R.__webglTexture,i.TEXTURE0+O);const X=n.get(Z);if(Z.version!==X.__version||Y===!0){e.activeTexture(i.TEXTURE0+O);const yt=Gt.getPrimaries(Gt.workingColorSpace),rt=x.colorSpace===Jn?null:Gt.getPrimaries(x.colorSpace),vt=x.colorSpace===Jn||yt===rt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,vt);const Ct=x.isCompressedTexture||x.image[0].isCompressedTexture,tt=x.image[0]&&x.image[0].isDataTexture,ot=[];for(let $=0;$<6;$++)!Ct&&!tt?ot[$]=M(x.image[$],!0,s.maxCubemapSize):ot[$]=tt?x.image[$].image:x.image[$],ot[$]=oe(x,ot[$]);const gt=ot[0],St=r.convert(x.format,x.colorSpace),at=r.convert(x.type),Ot=E(x.internalFormat,St,at,x.colorSpace),U=x.isVideoTexture!==!0,ut=X.__version===void 0||Y===!0,et=Z.dataReady;let dt=T(x,gt);Rt(i.TEXTURE_CUBE_MAP,x);let Q;if(Ct){U&&ut&&e.texStorage2D(i.TEXTURE_CUBE_MAP,dt,Ot,gt.width,gt.height);for(let $=0;$<6;$++){Q=ot[$].mipmaps;for(let it=0;it<Q.length;it++){const Dt=Q[it];x.format!==on?St!==null?U?et&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,it,0,0,Dt.width,Dt.height,St,Dt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,it,Ot,Dt.width,Dt.height,0,Dt.data):Pt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?et&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,it,0,0,Dt.width,Dt.height,St,at,Dt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,it,Ot,Dt.width,Dt.height,0,St,at,Dt.data)}}}else{if(Q=x.mipmaps,U&&ut){Q.length>0&&dt++;const $=Mt(ot[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,dt,Ot,$.width,$.height)}for(let $=0;$<6;$++)if(tt){U?et&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,ot[$].width,ot[$].height,St,at,ot[$].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Ot,ot[$].width,ot[$].height,0,St,at,ot[$].data);for(let it=0;it<Q.length;it++){const le=Q[it].image[$].image;U?et&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,it+1,0,0,le.width,le.height,St,at,le.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,it+1,Ot,le.width,le.height,0,St,at,le.data)}}else{U?et&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,St,at,ot[$]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Ot,St,at,ot[$]);for(let it=0;it<Q.length;it++){const Dt=Q[it];U?et&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,it+1,0,0,St,at,Dt.image[$]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,it+1,Ot,St,at,Dt.image[$])}}}m(x)&&d(i.TEXTURE_CUBE_MAP),X.__version=Z.version,x.onUpdate&&x.onUpdate(x)}R.__version=x.version}function mt(R,x,O,Y,Z,X){const yt=r.convert(O.format,O.colorSpace),rt=r.convert(O.type),vt=E(O.internalFormat,yt,rt,O.colorSpace),Ct=n.get(x),tt=n.get(O);if(tt.__renderTarget=x,!Ct.__hasExternalTextures){const ot=Math.max(1,x.width>>X),gt=Math.max(1,x.height>>X);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?e.texImage3D(Z,X,vt,ot,gt,x.depth,0,yt,rt,null):e.texImage2D(Z,X,vt,ot,gt,0,yt,rt,null)}e.bindFramebuffer(i.FRAMEBUFFER,R),ye(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,Z,tt.__webglTexture,0,L(x)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,Z,tt.__webglTexture,X),e.bindFramebuffer(i.FRAMEBUFFER,null)}function Lt(R,x,O){if(i.bindRenderbuffer(i.RENDERBUFFER,R),x.depthBuffer){const Y=x.depthTexture,Z=Y&&Y.isDepthTexture?Y.type:null,X=b(x.stencilBuffer,Z),yt=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;ye(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,L(x),X,x.width,x.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,L(x),X,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,X,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,yt,i.RENDERBUFFER,R)}else{const Y=x.textures;for(let Z=0;Z<Y.length;Z++){const X=Y[Z],yt=r.convert(X.format,X.colorSpace),rt=r.convert(X.type),vt=E(X.internalFormat,yt,rt,X.colorSpace);ye(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,L(x),vt,x.width,x.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,L(x),vt,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,vt,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function xt(R,x,O){const Y=x.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,R),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=n.get(x.depthTexture);if(Z.__renderTarget=x,(!Z.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),Y){if(Z.__webglInit===void 0&&(Z.__webglInit=!0,x.depthTexture.addEventListener("dispose",C)),Z.__webglTexture===void 0){Z.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,Z.__webglTexture),Rt(i.TEXTURE_CUBE_MAP,x.depthTexture);const Ct=r.convert(x.depthTexture.format),tt=r.convert(x.depthTexture.type);let ot;x.depthTexture.format===kn?ot=i.DEPTH_COMPONENT24:x.depthTexture.format===xi&&(ot=i.DEPTH24_STENCIL8);for(let gt=0;gt<6;gt++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+gt,0,ot,x.width,x.height,0,Ct,tt,null)}}else G(x.depthTexture,0);const X=Z.__webglTexture,yt=L(x),rt=Y?i.TEXTURE_CUBE_MAP_POSITIVE_X+O:i.TEXTURE_2D,vt=x.depthTexture.format===xi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(x.depthTexture.format===kn)ye(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,vt,rt,X,0,yt):i.framebufferTexture2D(i.FRAMEBUFFER,vt,rt,X,0);else if(x.depthTexture.format===xi)ye(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,vt,rt,X,0,yt):i.framebufferTexture2D(i.FRAMEBUFFER,vt,rt,X,0);else throw new Error("Unknown depthTexture format")}function Ht(R){const x=n.get(R),O=R.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==R.depthTexture){const Y=R.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),Y){const Z=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,Y.removeEventListener("dispose",Z)};Y.addEventListener("dispose",Z),x.__depthDisposeCallback=Z}x.__boundDepthTexture=Y}if(R.depthTexture&&!x.__autoAllocateDepthBuffer)if(O)for(let Y=0;Y<6;Y++)xt(x.__webglFramebuffer[Y],R,Y);else{const Y=R.texture.mipmaps;Y&&Y.length>0?xt(x.__webglFramebuffer[0],R,0):xt(x.__webglFramebuffer,R,0)}else if(O){x.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(e.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[Y]),x.__webglDepthbuffer[Y]===void 0)x.__webglDepthbuffer[Y]=i.createRenderbuffer(),Lt(x.__webglDepthbuffer[Y],R,!1);else{const Z=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,X=x.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,X),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,X)}}else{const Y=R.texture.mipmaps;if(Y&&Y.length>0?e.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=i.createRenderbuffer(),Lt(x.__webglDepthbuffer,R,!1);else{const Z=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,X=x.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,X),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,X)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function De(R,x,O){const Y=n.get(R);x!==void 0&&mt(Y.__webglFramebuffer,R,R.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&Ht(R)}function Vt(R){const x=R.texture,O=n.get(R),Y=n.get(x);R.addEventListener("dispose",w);const Z=R.textures,X=R.isWebGLCubeRenderTarget===!0,yt=Z.length>1;if(yt||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=x.version,a.memory.textures++),X){O.__webglFramebuffer=[];for(let rt=0;rt<6;rt++)if(x.mipmaps&&x.mipmaps.length>0){O.__webglFramebuffer[rt]=[];for(let vt=0;vt<x.mipmaps.length;vt++)O.__webglFramebuffer[rt][vt]=i.createFramebuffer()}else O.__webglFramebuffer[rt]=i.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){O.__webglFramebuffer=[];for(let rt=0;rt<x.mipmaps.length;rt++)O.__webglFramebuffer[rt]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(yt)for(let rt=0,vt=Z.length;rt<vt;rt++){const Ct=n.get(Z[rt]);Ct.__webglTexture===void 0&&(Ct.__webglTexture=i.createTexture(),a.memory.textures++)}if(R.samples>0&&ye(R)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let rt=0;rt<Z.length;rt++){const vt=Z[rt];O.__webglColorRenderbuffer[rt]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[rt]);const Ct=r.convert(vt.format,vt.colorSpace),tt=r.convert(vt.type),ot=E(vt.internalFormat,Ct,tt,vt.colorSpace,R.isXRRenderTarget===!0),gt=L(R);i.renderbufferStorageMultisample(i.RENDERBUFFER,gt,ot,R.width,R.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+rt,i.RENDERBUFFER,O.__webglColorRenderbuffer[rt])}i.bindRenderbuffer(i.RENDERBUFFER,null),R.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),Lt(O.__webglDepthRenderbuffer,R,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(X){e.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Rt(i.TEXTURE_CUBE_MAP,x);for(let rt=0;rt<6;rt++)if(x.mipmaps&&x.mipmaps.length>0)for(let vt=0;vt<x.mipmaps.length;vt++)mt(O.__webglFramebuffer[rt][vt],R,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,vt);else mt(O.__webglFramebuffer[rt],R,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+rt,0);m(x)&&d(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(yt){for(let rt=0,vt=Z.length;rt<vt;rt++){const Ct=Z[rt],tt=n.get(Ct);let ot=i.TEXTURE_2D;(R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(ot=R.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(ot,tt.__webglTexture),Rt(ot,Ct),mt(O.__webglFramebuffer,R,Ct,i.COLOR_ATTACHMENT0+rt,ot,0),m(Ct)&&d(ot)}e.unbindTexture()}else{let rt=i.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(rt=R.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(rt,Y.__webglTexture),Rt(rt,x),x.mipmaps&&x.mipmaps.length>0)for(let vt=0;vt<x.mipmaps.length;vt++)mt(O.__webglFramebuffer[vt],R,x,i.COLOR_ATTACHMENT0,rt,vt);else mt(O.__webglFramebuffer,R,x,i.COLOR_ATTACHMENT0,rt,0);m(x)&&d(rt),e.unbindTexture()}R.depthBuffer&&Ht(R)}function $t(R){const x=R.textures;for(let O=0,Y=x.length;O<Y;O++){const Z=x[O];if(m(Z)){const X=y(R),yt=n.get(Z).__webglTexture;e.bindTexture(X,yt),d(X),e.unbindTexture()}}}const ie=[],Ft=[];function Se(R){if(R.samples>0){if(ye(R)===!1){const x=R.textures,O=R.width,Y=R.height;let Z=i.COLOR_BUFFER_BIT;const X=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,yt=n.get(R),rt=x.length>1;if(rt)for(let Ct=0;Ct<x.length;Ct++)e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ct,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ct,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,yt.__webglMultisampledFramebuffer);const vt=R.texture.mipmaps;vt&&vt.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,yt.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,yt.__webglFramebuffer);for(let Ct=0;Ct<x.length;Ct++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),rt){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,yt.__webglColorRenderbuffer[Ct]);const tt=n.get(x[Ct]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,tt,0)}i.blitFramebuffer(0,0,O,Y,0,0,O,Y,Z,i.NEAREST),l===!0&&(ie.length=0,Ft.length=0,ie.push(i.COLOR_ATTACHMENT0+Ct),R.depthBuffer&&R.resolveDepthBuffer===!1&&(ie.push(X),Ft.push(X),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Ft)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ie))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),rt)for(let Ct=0;Ct<x.length;Ct++){e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ct,i.RENDERBUFFER,yt.__webglColorRenderbuffer[Ct]);const tt=n.get(x[Ct]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,yt.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ct,i.TEXTURE_2D,tt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,yt.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&l){const x=R.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[x])}}}function L(R){return Math.min(s.maxSamples,R.samples)}function ye(R){const x=n.get(R);return R.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function qt(R){const x=a.render.frame;f.get(R)!==x&&(f.set(R,x),R.update())}function oe(R,x){const O=R.colorSpace,Y=R.format,Z=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||O!==$i&&O!==Jn&&(Gt.getTransfer(O)===Jt?(Y!==on||Z!==He)&&Pt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):kt("WebGLTextures: Unsupported texture color space:",O)),x}function Mt(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(c.width=R.naturalWidth||R.width,c.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(c.width=R.displayWidth,c.height=R.displayHeight):(c.width=R.width,c.height=R.height),c}this.allocateTextureUnit=N,this.resetTextureUnits=I,this.setTexture2D=G,this.setTexture2DArray=V,this.setTexture3D=F,this.setTextureCube=q,this.rebindTextures=De,this.setupRenderTarget=Vt,this.updateRenderTargetMipmap=$t,this.updateMultisampleRenderTarget=Se,this.setupDepthRenderbuffer=Ht,this.setupFrameBufferTexture=mt,this.useMultisampledRTT=ye,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function V_(i,t){function e(n,s=Jn){let r;const a=Gt.getTransfer(s);if(n===He)return i.UNSIGNED_BYTE;if(n===Co)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Po)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Lc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Uc)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Dc)return i.BYTE;if(n===Ic)return i.SHORT;if(n===Ss)return i.UNSIGNED_SHORT;if(n===Ro)return i.INT;if(n===wn)return i.UNSIGNED_INT;if(n===yn)return i.FLOAT;if(n===Vn)return i.HALF_FLOAT;if(n===Nc)return i.ALPHA;if(n===Fc)return i.RGB;if(n===on)return i.RGBA;if(n===kn)return i.DEPTH_COMPONENT;if(n===xi)return i.DEPTH_STENCIL;if(n===Do)return i.RED;if(n===Io)return i.RED_INTEGER;if(n===ji)return i.RG;if(n===Lo)return i.RG_INTEGER;if(n===Uo)return i.RGBA_INTEGER;if(n===or||n===lr||n===cr||n===hr)if(a===Jt)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===or)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===lr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===cr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===hr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===or)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===lr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===cr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===hr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ka||n===Ga||n===Ha||n===Wa)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===ka)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ga)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ha)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Wa)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Xa||n===Ya||n===qa||n===ja||n===$a||n===Za||n===Ka)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Xa||n===Ya)return a===Jt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===qa)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===ja)return r.COMPRESSED_R11_EAC;if(n===$a)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Za)return r.COMPRESSED_RG11_EAC;if(n===Ka)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Ja||n===Qa||n===to||n===eo||n===no||n===io||n===so||n===ro||n===ao||n===oo||n===lo||n===co||n===ho||n===uo)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Ja)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Qa)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===to)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===eo)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===no)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===io)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===so)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ro)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ao)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===oo)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===lo)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===co)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ho)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===uo)return a===Jt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===fo||n===po||n===mo)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===fo)return a===Jt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===po)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===mo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===_o||n===go||n===xo||n===vo)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===_o)return r.COMPRESSED_RED_RGTC1_EXT;if(n===go)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===xo)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===vo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ys?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}const k_=`
void main() {
...
`;console.log(m.split(`
`).map((P,g)=>`${g+1}: ${P}`).join(`
`));let d={uniforms:{resolution:{value:new At},uFocalLength:{value:0},viewMatrixInverse:{value:new jt},projectionMatrixInverse:{value:new jt},uCameraViewMatrix:{value:new jt},uCameraProjectionMatrix:{value:new jt},cameraPosition:{value:new D}},fragmentShader:m,depthWrite:!0},y=i.brickMap.initTexturesThreeJs(d),E=new mn(d),b=new g0(E),T;{let P=!1;T=()=>{P||(P=!0,requestAnimationFrame(()=>{let g=o();if(g==null)return;let v=r();if(v==null)return;let A=c();A!=null&&(A.update(),E.uniforms.viewMatrixInverse.value.copy(v.matrixWorld),E.uniforms.projectionMatrixInverse.value.copy(v.projectionMatrixInverse),E.uniforms.uCameraViewMatrix.value.copy(v.matrixWorldInverse),E.uniforms.uCameraProjectionMatrix.value.copy(v.projectionMatrix),E.uniforms.cameraPosition.value.copy(v.position),g.clearDepth(),b.render(g),g.render(p,v),P=!1)}))}}let C=new yo,w=new At;return i.onInit({canvasSize:n,onBrickMapChanged(){i.brickMap.updateTexturesThreeJs(y),T()},rerender:T,moveTransform(){u()?.setMode("translate")},rotateTransform(){u()?.setMode("rotate")},scaleTransform(){u()?.setMode("scale")},screenCoordsToRay(P,g){let v=n();if(v==null)return;let A=r();if(A==null)return;let I=w.set(P.x/v.x*2-1,-(P.y/v.y)*2+1),N=C;N.setFromCamera(I,A),g.copy(N.ray)},*getThreeObjectsUnderScreenCoords(P){let g=n();if(g==null)return;let v=r();if(v==null)return;let A=new At(P.x/g.x*2-1,-(P.y/g.y)*2+1),I=new yo;I.setFromCamera(A,v);for(let N of I.intersectObject(p,!0))yield N.object}}),bh(()=>{let P=t();if(P==null)return;let g=new an(uc,1,10,1e4);g.position.set(0,0,5e3),g.lookAt(new D(0,0,0));let v=new Z_({canvas:P});v.setPixelRatio(window.devicePixelRatio),v.autoClear=!1;let A=new ResizeObserver(()=>{let V=P.getBoundingClientRect();s(new At(V.width,V.height)),g.aspect=V.width/V.height,g.updateProjectionMatrix();let F=V.width*window.devicePixelRatio,q=V.height*window.devicePixelRatio,J=.5*q/Math.tan(.5*uc*Math.PI/180);v.setSize(V.width,V.height,!1),E.uniforms.resolution.value.set(F,q),E.uniforms.uFocalLength.value=J,T()});A.observe(P),vs(()=>{A.unobserve(P),A.disconnect()});let I=new e0(g,P);I.enableDamping=!1,I.update(),I.addEventListener("change",()=>T());let N=new x0(g,P);ei(ni(()=>i.useTransformControlOnObject3D,V=>{V==null?N.detach():N.attach(V)}));let[z,G]=fn(!1);N.addEventListener("dragging-changed",V=>{let F=V.value;G(F),i.onDragingEvent(F)}),ei(()=>{I.enabled=!(z()||i.disableOrbit)}),N.addEventListener("change",()=>{T()}),p.add(N.getHelper()),xs(()=>{a(g),l(v),f(I),h(N)}),T()}),ei(ni(()=>i.overlayObject3D,P=>{P!=null&&(p.add(P),vs(()=>{p.remove(P)}),$e(()=>T()))})),(()=>{var P=w0(),g=e;return typeof g=="function"?Sc(g,P):e=P,en(P,"width","100%"),en(P,"height","100%"),P})()},Ao=Symbol("store-raw"),Xi=Symbol("store-node"),Fn=Symbol("store-has"),ah=Symbol("store-self");function oh(i){let t=i[vi];if(!t&&(Object.defineProperty(i,vi,{value:t=new Proxy(i,D0)}),!Array.isArray(i))){const e=Object.keys(i),n=Object.getOwnPropertyDescriptors(i);for(let s=0,r=e.length;s<r;s++){const a=e[s];n[a].get&&Object.defineProperty(i,a,{enumerable:n[a].enumerable,get:n[a].get.bind(t)})}}return t}function Tr(i){let t;return i!=null&&typeof i=="object"&&(i[vi]||!(t=Object.getPrototypeOf(i))||t===Object.prototype||Array.isArray(i))}function Ts(i,t=new Set){let e,n,s,r;if(e=i!=null&&i[Ao])return e;if(!Tr(i)||t.has(i))return i;if(Array.isArray(i)){Object.isFrozen(i)?i=i.slice(0):t.add(i);for(let a=0,o=i.length;a<o;a++)s=i[a],(n=Ts(s,t))!==s&&(i[a]=n)}else{Object.isFrozen(i)?i=Object.assign({},i):t.add(i);const a=Object.keys(i),o=Object.getOwnPropertyDescriptors(i);for(let l=0,c=a.length;l<c;l++)r=a[l],!o[r].get&&(s=i[r],(n=Ts(s,t))!==s&&(i[r]=n))}return i}function Ar(i,t){let e=i[t];return e||Object.defineProperty(i,t,{value:e=Object.create(null)}),e}function As(i,t,e){if(i[t])return i[t];const[n,s]=fn(e,{equals:!1,internal:!0});return n.$=s,i[t]=n}function C0(i,t){const e=Reflect.getOwnPropertyDescriptor(i,t);return!e||e.get||!e.configurable||t===vi||t===Xi||(delete e.value,delete e.writable,e.get=()=>i[vi][t]),e}function lh(i){ba()&&As(Ar(i,Xi),ah)()}function P0(i){return lh(i),Reflect.ownKeys(i)}const D0={get(i,t,e){if(t===Ao)return i;if(t===vi)return e;if(t===Zo)return lh(i),e;const n=Ar(i,Xi),s=n[t];let r=s?s():i[t];if(t===Xi||t===Fn||t==="__proto__")return r;if(!s){const a=Object.getOwnPropertyDescriptor(i,t);ba()&&(typeof r!="function"||i.hasOwnProperty(t))&&!(a&&a.get)&&(r=As(n,t,r)())}return Tr(r)?oh(r):r},has(i,t){return t===Ao||t===vi||t===Zo||t===Xi||t===Fn||t==="__proto__"?!0:(ba()&&As(Ar(i,Fn),t)(),t in i)},set(){return!0},deleteProperty(){return!0},ownKeys:P0,getOwnPropertyDescriptor:C0};function wr(i,t,e,n=!1){if(!n&&i[t]===e)return;const s=i[t],r=i.length;e===void 0?(delete i[t],i[Fn]&&i[Fn][t]&&s!==void 0&&i[Fn][t].$()):(i[t]=e,i[Fn]&&i[Fn][t]&&s===void 0&&i[Fn][t].$());let a=Ar(i,Xi),o;if((o=As(a,t,s))&&o.$(()=>e),Array.isArray(i)&&i.length!==r){for(let l=i.length;l<r;l++)(o=a[l])&&o.$();(o=As(a,"length",r))&&o.$(i.length)}(o=a[ah])&&o.$()}function ch(i,t){const e=Object.keys(t);for(let n=0;n<e.length;n+=1){const s=e[n];wr(i,s,t[s])}}function I0(i,t){if(typeof t=="function"&&(t=t(i)),t=Ts(t),Array.isArray(t)){if(i===t)return;let e=0,n=t.length;for(;e<n;e++){const s=t[e];i[e]!==s&&wr(i,e,s)}wr(i,"length",n)}else ch(i,t)}function gs(i,t,e=[]){let n,s=i;if(t.length>1){n=t.shift();const a=typeof n,o=Array.isArray(i);if(Array.isArray(n)){for(let l=0;l<n.length;l++)gs(i,[n[l]].concat(t),e);return}else if(o&&a==="function"){for(let l=0;l<i.length;l++)n(i[l],l)&&gs(i,[l].concat(t),e);return}else if(o&&a==="object"){const{from:l=0,to:c=i.length-1,by:f=1}=n;for(let u=l;u<=c;u+=f)gs(i,[u].concat(t),e);return}else if(t.length>1){gs(i[n],t,[n].concat(e));return}s=i[n],e=[n].concat(e)}let r=t[0];typeof r=="function"&&(r=r(s,e),r===s)||n===void 0&&r==null||(r=Ts(r),n===void 0||Tr(s)&&Tr(r)&&!Array.isArray(r)?ch(s,r):wr(i,n,r))}function hh(...[i,t]){const e=Ts(i||{}),n=Array.isArray(e),s=oh(e);function r(...a){xs(()=>{n&&a.length===1?I0(e,a[0]):gs(e,a)})}return[s,r]}class fc{constructor(t){}}var L0=_n('<button class="btn btn-primary">End Draw Mode');class U0{instructions;disableOrbit=()=>!0;constructor(t){let e=pe(()=>t.canvasSize()!=null),n=pe(()=>t.pointerPos()!=null);ei(ni([e,n,t.pointerDown],([r,a,o])=>{if(!r||!a||!o)return;let l=t.canvasSize,c=t.pointerPos,f,u;{let h=$e(l),p=$e(c);f=p.x-.5*h.x,u=-p.y+.5*h.y}N0(t.brickMap,f,u),t.updateSdf(),ei(ni(c,h=>{let p=$e(l),_=h.x-.5*p.x,M=-h.y+.5*p.y,m=_-f,d=M-u;m*m+d*d<=25||(F0(t.brickMap,f,u,_,M),f=_,u=M,t.updateSdf())},{defer:!0}))}));let s=()=>(()=>{var r=L0();return r.$$click=()=>t.endMode(),r})();this.instructions=s}}function N0(i,t,e){let n=512+Math.round(t),s=512+Math.round(e),r=512,a=20;for(let o=-a-2;o<=a+2;++o)for(let l=-a-2;l<=a+2;++l)for(let c=-a-2;c<=a+2;++c){let f=Math.sqrt(o*o+l*l+c*c)-a;if(f/=Math.sqrt(3),f<-1||f>1)continue;let u=128-Math.floor(Math.max(-1,Math.min(1,f))*127);u<1&&(u=1),u>255&&(u=255);let h=n+c,p=s+l,_=r+o;h<0||h>=1024||p<0||p>=1024||_<0||_>=1024||i.set(h,p,_,u)}}function F0(i,t,e,n,s){let r=512+Math.round(t),a=512+Math.round(e),o=512,l=512+Math.round(n),c=512+Math.round(s),f=512,u=20,h=l-r,p=c-a,_=f-o,M=h*h+p*p+_*_,m=(w,P,g)=>{let v=((w-r)*h+(P-a)*p+(g-o)*_)/M;v=Math.max(0,Math.min(1,v));let A=r+h*v,I=a+p*v,N=o+_*v,z=w-A,G=P-I,V=g-N;return Math.sqrt(z*z+G*G+V*V)-u},d=Math.min(r,l)-u,y=Math.max(r,l)+u,E=Math.min(a,c)-u,b=Math.max(a,c)+u,T=Math.min(o,f)-u,C=Math.max(o,f)+u;for(let w=T-2;w<=C+2;++w)for(let P=E-2;P<=b+2;++P)for(let g=d-2;g<=y+2;++g){if(w<0||w>=1024||P<0||P>=1024||g<0||g>=1024)continue;let v=m(g,P,w);if(v/=Math.sqrt(3),v<-1||v>1)continue;let A=128-Math.floor(Math.max(-1,Math.min(1,v))*127);A<1&&(A=1),A>255&&(A=255);let I=i.get(g,P,w);I!=0&&(A=Math.max(A,I)),i.set(g,P,w,A)}}Pr(["click"]);class O0{value;constructor(t){this.value=t}}var B0=_n('<div><label class="label bg-base-100">Select a primitive to insert, OR select an existing primitive on the screen to transform:'),z0=_n('<button class="btn btn-primary">Sphere'),V0=_n('<button class="btn btn-primary ml-2">Cube'),k0=_n('<div><label class="label bg-base-100">Otherwise if your finish, press the I am finished button:'),G0=_n('<button class="btn btn-primary">I am finished'),H0=_n('<div><label class="label bg-base-100">Transform the primitive, then click place it:'),W0=_n('<button class="btn btn-primary">Place It');const zi=1500,rr=1e3;class X0{instructions;overlayObject3D;useTransformControlOnObject3D;onClick;constructor(t){let[e,n]=hh({existingPrimitives:[],movingExistingPrimitive:void 0,insertingPrimitive:void 0});vs(()=>{for(let h of e.existingPrimitives)h.value.cleanup();n("existingPrimitives",[])});let s=h=>{n("insertingPrimitive",h)},r=()=>{let h=o();h!=null?(h.autoCleanup=!1,xs(()=>{n("insertingPrimitive",void 0),n("existingPrimitives",p=>[...p,new O0({primitive:h.primitive,object:h.object,cleanup:h.cleanup})])})):e.movingExistingPrimitive!=null&&n("movingExistingPrimitive",void 0)},a=()=>{let h=[];for(let w of e.existingPrimitives){let P=w.value,g=P.object,v=new D,A=new we,I=new D;g.matrix.decompose(v,A,I);let N,z=new we;if(z.copy(A),z.conjugate(),P.primitive=="Sphere"){let G=new D(rr,rr,rr).multiply(I),V=new D,F=new D,q=new D().copy(G).multiply(G);N=J=>{V.copy(J),V.sub(v),V.applyQuaternion(z),F.copy(V),V.divide(G),F.divide(q);let nt=V.length(),st=F.length();return nt*(nt-1)/st}}else{let G=new D(zi,zi,zi).multiply(I).multiplyScalar(.5),V=new D,F=new D;N=q=>{V.copy(q),V.sub(v),V.applyQuaternion(z),F.copy(V),F.x=Math.abs(F.x),F.y=Math.abs(F.y),F.z=Math.abs(F.z),F.sub(G);let J=Math.min(Math.max(F.x,F.y,F.z),0);return F.x=Math.max(F.x,0),F.y=Math.max(F.y,0),F.z=Math.max(F.z,0),F.length()+J}}h.push(N)}let p=w=>{let P=h[0](w);for(let g=1;g<h.length;++g)P=Math.min(P,h[g](w));return P},_=new Si;{let w=!0,P=new Si;for(let g of e.existingPrimitives){let v=g.value.object;v instanceof ft&&v.geometry instanceof Ue&&v.geometry.computeBoundingBox(),P.setFromObject(v),w?(_.copy(P),w=!1):_.union(P)}}let M=Math.sqrt(3),m=new D,d=Math.max(0,512+Math.floor(_.min.z/10))-1,y=Math.min(1023,512+Math.ceil(_.max.z/10))+1,E=Math.max(0,512+Math.floor(_.min.y/10))-1,b=Math.min(1023,512+Math.ceil(_.max.y/10))+1,T=Math.max(0,512+Math.floor(_.min.x/10))-1,C=Math.min(1023,512+Math.ceil(_.max.x/10))+1;for(let w=d;w<=y;++w){let P=(w-512)*10;for(let g=E;g<=b;++g){let v=(g-512)*10;for(let A=T;A<=C;++A){let I=(A-512)*10;m.set(I,v,P);let N=p(m)/(10*M);if(N<-1||N>1)continue;let z=128-Math.floor(Math.max(-1,Math.min(1,N))*127);z<1&&(z=1),z>255&&(z=255),t.brickMap.set(A,g,w,z)}}}t.updateSdf(),t.endMode()},o=pe(ni(()=>e.insertingPrimitive,h=>{if(h==null)return;let p,_=new $c({color:"blue"});switch(h){case"Cube":{p=new ve(zi,zi,zi);break}case"Sphere":{p=new Ps(rr);break}default:throw new Error("Unreachable")}let M=new ft(p,_),m={primitive:h,autoCleanup:!0,cleanup:()=>{p.dispose(),_.dispose()},object:M};return vs(()=>{m.autoCleanup&&m.cleanup()}),m})),l=()=>Qn(Dh,{get children(){return[Qn(Ko,{get when(){return Ih(()=>e.insertingPrimitive==null)()&&e.movingExistingPrimitive==null},get children(){return[B0(),(()=>{var h=z0();return h.$$click=()=>s("Sphere"),h})(),(()=>{var h=V0();return h.$$click=()=>s("Cube"),h})(),k0(),(()=>{var h=G0();return h.$$click=()=>a(),h})()]}}),Qn(Ko,{get when(){return e.insertingPrimitive!=null||e.movingExistingPrimitive!=null},get children(){return[H0(),(()=>{var h=W0();return h.$$click=()=>r(),h})()]}})]}}),c=pe(()=>{let h=o()?.object;if(h==null&&e.existingPrimitives.length==0)return;let p=new ds;h!=null&&p.add(h);for(let _ of e.existingPrimitives)p.add(_.value.object);return p}),f=pe(()=>o()?.object??e.movingExistingPrimitive),u=()=>{if(e.movingExistingPrimitive!=null||e.insertingPrimitive!=null)return;let h=t.pointerPos();if(h!=null){let p=new Set;for(let _ of e.existingPrimitives)p.add(_.value.object);for(let _ of t.getThreeObjectsUnderScreenCoords(h))if(p.has(_)){n("movingExistingPrimitive",_);break}}};this.instructions=l,this.overlayObject3D=c,this.useTransformControlOnObject3D=f,this.onClick=u}}Pr(["click"]);var Y0=_n('<button class="btn btn-primary">End Sculpt Mode');class q0{instructions;disableOrbit;overlayObject3D;constructor(t){let e=new sh().copy(t.brickMap),n=pe(()=>{let u=t.pointerPos();if(u==null)return;let h=new Rs;return t.screenCoordsToRay(u,h),h}),s=pe(()=>{let u=n();if(u==null)return;let h=[0];return e.march(u.origin,u.direction,h)?new D().copy(u.direction).multiplyScalar(h[0]).add(u.origin):void 0});ei(ni(t.pointerDown,u=>{if(!u){e.copy(t.brickMap);return}let h=pe(()=>s()!=null);ei(ni(h,p=>{if(!p)return;let _=s;j0(t.brickMap,_()),t.updateSdf();let M=_();ei(ni(_,m=>{M.distanceTo(m)<15||($0(t.brickMap,M,m),t.updateSdf(),M=m)},{defer:!0}))}))},{defer:!0}));let r=new Ps(40),a=new $c({color:"blue"});vs(()=>{r.dispose(),a.dispose()});let o=new ft(r,a),l=()=>(()=>{var u=Y0();return u.$$click=()=>t.endMode(),u})(),c=pe(()=>s()!=null),f=pe(()=>{let u=s();if(u==null){t.rerender();return}return o.position.copy(u),o.updateMatrix(),o.matrixWorldNeedsUpdate=!0,t.rerender(),o});this.instructions=l,this.disableOrbit=c,this.overlayObject3D=f}}function j0(i,t){let e=512+Math.round(t.x/10),n=512+Math.round(t.y/10),s=512+Math.round(t.z/10),r=4;for(let a=-r-2;a<=r+2;++a)for(let o=-r-2;o<=r+2;++o)for(let l=-r-2;l<=r+2;++l){let c=e+l,f=n+o,u=s+a;if(c<0||c>=1024||f<0||f>=1024||u<0||u>=1024)continue;let h=Math.sqrt(a*a+o*o+l*l)-r;h/=Math.sqrt(3);let p=i.get(c,f,u),_=128-Math.floor(Math.max(-1,Math.min(1,-h))*127);_=Math.min(_,p),_<1&&(_=1),_>255&&(_=255),i.set(c,f,u,_)}}function $0(i,t,e){let n=512+Math.round(t.x/10),s=512+Math.round(t.y/10),r=512+Math.round(t.z/10),a=512+Math.round(e.x/10),o=512+Math.round(e.y/10),l=512+Math.round(e.z/10),c=4,f=a-n,u=o-s,h=l-r,p=f*f+u*u+h*h,_=(T,C,w)=>{let P=((T-n)*f+(C-s)*u+(w-r)*h)/p;P=Math.max(0,Math.min(1,P));let g=n+f*P,v=s+u*P,A=r+h*P,I=T-g,N=C-v,z=w-A;return Math.sqrt(I*I+N*N+z*z)-c},M=Math.min(n,a)-c,m=Math.max(n,a)+c,d=Math.min(s,o)-c,y=Math.max(s,o)+c,E=Math.min(r,l)-c,b=Math.max(r,l)+c;for(let T=E-2;T<=b+2;++T)for(let C=d-2;C<=y+2;++C)for(let w=M-2;w<=m+2;++w){if(T<0||T>=1024||C<0||C>=1024||w<0||w>=1024)continue;let P=_(w,C,T);P/=Math.sqrt(3);let g=128-Math.floor(Math.max(-1,Math.min(1,-P))*127);g<1&&(g=1),g>255&&(g=255);let v=i.get(w,C,T);g=Math.min(g,v),i.set(w,C,T,g)}}Pr(["click"]);var Z0=_n('<div><div style=touch-action:none></div><div class="ml-2 mt-2"><div><button class="btn btn-primary">Insert Primitive</button><button class="btn btn-primary ml-2">Draw</button><button class="btn btn-primary ml-2">Sculpt</button><button class="btn btn-primary ml-2">Spin</button><button class="btn btn-primary ml-2">Move</button><button class="btn btn-primary ml-2">Rotate</button><button class="btn btn-primary ml-2">Scale');const K0=()=>{let[i,t]=hh({mkMode:fc,pointerPos:void 0,pointerDown:!1}),e=new sh,[n,s]=fn(),r=v=>t("mkMode",()=>v),a={endMode:()=>r(fc),brickMap:e,canvasSize:()=>n()?.canvasSize(),pointerPos:()=>i.pointerPos,pointerDown:()=>i.pointerDown,updateSdf:()=>{n()?.onBrickMapChanged()},rerender:()=>{n()?.rerender()},screenCoordsToRay(v,A){n()?.screenCoordsToRay(v,A)},*getThreeObjectsUnderScreenCoords(v){let A=n()?.getThreeObjectsUnderScreenCoords(v);A!=null&&(yield*A)}},o=pe(()=>new i.mkMode(a)),l=()=>Qn(Ph,{get when(){return o().instructions},keyed:!0,children:v=>Qn(v,{})}),c=pe(()=>o().disableOrbit?.()??!1),f=pe(()=>o().overlayObject3D?.()),u=pe(()=>o().useTransformControlOnObject3D?.()),[h,p]=fn(),[_,M]=fn(!1);function m(v,A,I){let N=v,z=A,G=I;return Math.sqrt(N*N+z*z+G*G)-100}for(let v=-105;v<=105;++v)for(let A=-105;A<=105;++A)for(let I=-105;I<=105;++I){let N=m(v,A,I);N/=Math.sqrt(3);let z=128-Math.floor(Math.max(-1,Math.min(1,N))*127);z<1&&(z=1),z>255&&(z=255),e.set(512+I,512+A,512+v,z)}let d,y=v=>{if(_())return;let A=h();if(A==null)return;A.setPointerCapture(v.pointerId);let I=A.getBoundingClientRect(),N=v.clientX-I.left,z=v.clientY-I.top;xs(()=>{t("pointerPos",new At(N,z)),t("pointerDown",!0)}),d=performance.now()},E=v=>{if(_())return;let A=h();if(A==null)return;A.setPointerCapture(v.pointerId);let I=A.getBoundingClientRect(),N=v.clientX-I.left,z=v.clientY-I.top;t("pointerPos",new At(N,z))},b=v=>{if(_())return;let A=h();if(A==null)return;let I;d!=null&&(I=performance.now()-d),d=void 0,A.releasePointerCapture(v.pointerId);let N=A.getBoundingClientRect();v.clientX-N.left,v.clientY-N.top,xs(()=>{t("pointerDown",!1)}),I!=null&&I<300&&T()},T=()=>{o().onClick?.()},C=()=>{requestAnimationFrame(()=>{})},w=()=>{n()?.moveTransform()},P=()=>{n()?.rotateTransform()},g=()=>{n()?.scaleTransform()};return(()=>{var v=Z0(),A=v.firstChild,I=A.nextSibling,N=I.firstChild,z=N.firstChild,G=z.nextSibling,V=G.nextSibling,F=V.nextSibling,q=F.nextSibling,J=q.nextSibling,nt=J.nextSibling;en(v,"position","relative"),en(v,"width","100%"),en(v,"height","100%"),A.$$pointerup=b,A.$$pointermove=E,A.$$pointerdown=y;var st=p;return typeof st=="function"?Sc(st,A):p=A,en(A,"position","absolute"),en(A,"left","0"),en(A,"top","0"),en(A,"right","0"),en(A,"bottom","0"),Aa(A,Qn(R0,{brickMap:e,onDragingEvent:Rt=>{M(Rt)},onInit:Rt=>{s(Rt)},get disableOrbit(){return c()},get overlayObject3D(){return f()},get useTransformControlOnObject3D(){return u()}})),en(I,"position","absolute"),en(I,"left","0"),en(I,"top","0"),z.$$click=()=>r(X0),G.$$click=()=>r(U0),V.$$click=()=>r(q0),F.$$click=()=>C(),q.$$click=()=>w(),J.$$click=()=>P(),nt.$$click=()=>g(),Aa(I,Qn(l,{}),null),v})()};Pr(["pointerdown","pointermove","pointerup","click"]);const J0=document.getElementById("root");Uh(()=>Qn(K0,{}),J0);
