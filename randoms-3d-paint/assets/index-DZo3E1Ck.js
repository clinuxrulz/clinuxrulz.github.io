...
#define LOW_PRECISION`),t}const c_={[os]:"SHADOWMAP_TYPE_PCF",[dr]:"SHADOWMAP_TYPE_VSM"};function h_(i){return c_[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const u_={[Mi]:"ENVMAP_TYPE_CUBE",[ji]:"ENVMAP_TYPE_CUBE",[Is]:"ENVMAP_TYPE_CUBE_UV"};function f_(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":u_[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const d_={[ji]:"ENVMAP_MODE_REFRACTION"};function p_(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":d_[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const m_={[yc]:"ENVMAP_BLENDING_MULTIPLY",[iu]:"ENVMAP_BLENDING_MIX",[ru]:"ENVMAP_BLENDING_ADD"};function __(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":m_[i.combine]||"ENVMAP_BLENDING_NONE"}function g_(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function x_(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=h_(e),c=f_(e),f=p_(e),u=__(e),h=g_(e),p=e_(e),g=n_(s),M=r.createProgram();let m,d,y=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+d);const E=y+m+a,b=y+d+o,T=Xl(r,r.VERTEX_SHADER,E),R=Xl(r,r.FRAGMENT_SHADER,b);r.attachShader(M,T),r.attachShader(M,R),e.index0AttributeName!==void 0?r.bindAttribLocation(M,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function A(P){if(i.debug.checkShaderErrors){const N=r.getProgramInfoLog(M)||"",O=r.getShaderInfoLog(T)||"",V=r.getShaderInfoLog(R)||"",G=N.trim(),k=O.trim(),L=V.trim();let Y=!0,J=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(Y=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,M,T,R);else{const et=ql(r,T,"vertex"),it=ql(r,R,"fragment");kt("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
...
`;console.log(m.split(`
`).map((C,_)=>`${_+1}: ${C}`).join(`
`));let d={uniforms:{resolution:{value:new At},uFocalLength:{value:0},viewMatrixInverse:{value:new $t},projectionMatrixInverse:{value:new $t},uCameraViewMatrix:{value:new $t},uCameraProjectionMatrix:{value:new $t},cameraPosition:{value:new D}},fragmentShader:m,depthWrite:!0},y=i.brickMap.initTexturesThreeJs(d),E=new mn(d),b=new g0(E),T;{let C=!1;T=()=>{C||(C=!0,requestAnimationFrame(()=>{let _=o();if(_==null)return;let v=s();if(v==null)return;let P=c();P!=null&&(P.update(),E.uniforms.viewMatrixInverse.value.copy(v.matrixWorld),E.uniforms.projectionMatrixInverse.value.copy(v.projectionMatrixInverse),E.uniforms.uCameraViewMatrix.value.copy(v.matrixWorldInverse),E.uniforms.uCameraProjectionMatrix.value.copy(v.projectionMatrix),E.uniforms.cameraPosition.value.copy(v.position),_.clearDepth(),b.render(_),_.render(p,v),C=!1)}))}}let R=new yo,A=new At;return i.onInit({canvasSize:n,onBrickMapChanged(){i.brickMap.updateTexturesThreeJs(y),T()},rerender:T,moveTransform(){u()?.setMode("translate")},rotateTransform(){u()?.setMode("rotate")},scaleTransform(){u()?.setMode("scale")},screenCoordsToRay(C,_){let v=n();if(v==null)return;let P=s();if(P==null)return;let N=A.set(C.x/v.x*2-1,-(C.y/v.y)*2+1),O=R;O.setFromCamera(N,P),_.copy(O.ray)},*getThreeObjectsUnderScreenCoords(C){let _=n();if(_==null)return;let v=s();if(v==null)return;let P=new At(C.x/_.x*2-1,-(C.y/_.y)*2+1),N=new yo;N.setFromCamera(P,v);for(let O of N.intersectObject(p,!0))yield O.object}}),bh(()=>{let C=t();if(C==null)return;let _=new an(uc,1,10,1e4);_.position.set(0,0,5e3),_.lookAt(new D(0,0,0));let v=new Z_({canvas:C});v.setPixelRatio(window.devicePixelRatio),v.autoClear=!1;let P=()=>{let L=C.getBoundingClientRect();r(new At(L.width,L.height)),_.aspect=L.width/L.height,_.updateProjectionMatrix();let Y=L.width*window.devicePixelRatio,J=L.height*window.devicePixelRatio,et=.5*J/Math.tan(.5*uc*Math.PI/180),it=1/i.pixelSize;v.setSize(it*L.width,it*L.height,!1),E.uniforms.resolution.value.set(it*Y,it*J),E.uniforms.uFocalLength.value=it*et,T()},N=new ResizeObserver(()=>{P()});On(zn(()=>i.pixelSize,()=>P(),{defer:!0})),N.observe(C),Mr(()=>{N.unobserve(C),N.disconnect()});let O=new e0(_,C);O.enableDamping=!1,O.update(),O.addEventListener("change",()=>T());let V=new x0(_,C);On(zn(()=>i.useTransformControlOnObject3D,L=>{L==null?V.detach():V.attach(L)}));let[G,k]=fn(!1);V.addEventListener("dragging-changed",L=>{let Y=L.value;k(Y),i.onDragingEvent(Y)}),On(()=>{O.enabled=!(G()||i.disableOrbit)}),V.addEventListener("change",()=>{T()}),p.add(V.getHelper()),vr(()=>{a(_),l(v),f(O),h(V)}),T()}),On(zn(()=>i.overlayObject3D,C=>{C!=null&&(p.add(C),Mr(()=>{p.remove(C)}),$e(()=>T()))})),(()=>{var C=w0(),_=e;return typeof _=="function"?Sc(_,C):e=C,en(C,"width","100%"),en(C,"height","100%"),C})()},Ao=Symbol("store-raw"),Yi=Symbol("store-node"),Fn=Symbol("store-has"),ah=Symbol("store-self");function oh(i){let t=i[vi];if(!t&&(Object.defineProperty(i,vi,{value:t=new Proxy(i,D0)}),!Array.isArray(i))){const e=Object.keys(i),n=Object.getOwnPropertyDescriptors(i);for(let r=0,s=e.length;r<s;r++){const a=e[r];n[a].get&&Object.defineProperty(i,a,{enumerable:n[a].enumerable,get:n[a].get.bind(t)})}}return t}function As(i){let t;return i!=null&&typeof i=="object"&&(i[vi]||!(t=Object.getPrototypeOf(i))||t===Object.prototype||Array.isArray(i))}function Ar(i,t=new Set){let e,n,r,s;if(e=i!=null&&i[Ao])return e;if(!As(i)||t.has(i))return i;if(Array.isArray(i)){Object.isFrozen(i)?i=i.slice(0):t.add(i);for(let a=0,o=i.length;a<o;a++)r=i[a],(n=Ar(r,t))!==r&&(i[a]=n)}else{Object.isFrozen(i)?i=Object.assign({},i):t.add(i);const a=Object.keys(i),o=Object.getOwnPropertyDescriptors(i);for(let l=0,c=a.length;l<c;l++)s=a[l],!o[s].get&&(r=i[s],(n=Ar(r,t))!==r&&(i[s]=n))}return i}function ws(i,t){let e=i[t];return e||Object.defineProperty(i,t,{value:e=Object.create(null)}),e}function wr(i,t,e){if(i[t])return i[t];const[n,r]=fn(e,{equals:!1,internal:!0});return n.$=r,i[t]=n}function C0(i,t){const e=Reflect.getOwnPropertyDescriptor(i,t);return!e||e.get||!e.configurable||t===vi||t===Yi||(delete e.value,delete e.writable,e.get=()=>i[vi][t]),e}function lh(i){ba()&&wr(ws(i,Yi),ah)()}function P0(i){return lh(i),Reflect.ownKeys(i)}const D0={get(i,t,e){if(t===Ao)return i;if(t===vi)return e;if(t===Zo)return lh(i),e;const n=ws(i,Yi),r=n[t];let s=r?r():i[t];if(t===Yi||t===Fn||t==="__proto__")return s;if(!r){const a=Object.getOwnPropertyDescriptor(i,t);ba()&&(typeof s!="function"||i.hasOwnProperty(t))&&!(a&&a.get)&&(s=wr(n,t,s)())}return As(s)?oh(s):s},has(i,t){return t===Ao||t===vi||t===Zo||t===Yi||t===Fn||t==="__proto__"?!0:(ba()&&wr(ws(i,Fn),t)(),t in i)},set(){return!0},deleteProperty(){return!0},ownKeys:P0,getOwnPropertyDescriptor:C0};function Rs(i,t,e,n=!1){if(!n&&i[t]===e)return;const r=i[t],s=i.length;e===void 0?(delete i[t],i[Fn]&&i[Fn][t]&&r!==void 0&&i[Fn][t].$()):(i[t]=e,i[Fn]&&i[Fn][t]&&r===void 0&&i[Fn][t].$());let a=ws(i,Yi),o;if((o=wr(a,t,r))&&o.$(()=>e),Array.isArray(i)&&i.length!==s){for(let l=i.length;l<s;l++)(o=a[l])&&o.$();(o=wr(a,"length",s))&&o.$(i.length)}(o=a[ah])&&o.$()}function ch(i,t){const e=Object.keys(t);for(let n=0;n<e.length;n+=1){const r=e[n];Rs(i,r,t[r])}}function I0(i,t){if(typeof t=="function"&&(t=t(i)),t=Ar(t),Array.isArray(t)){if(i===t)return;let e=0,n=t.length;for(;e<n;e++){const r=t[e];i[e]!==r&&Rs(i,e,r)}Rs(i,"length",n)}else ch(i,t)}function xr(i,t,e=[]){let n,r=i;if(t.length>1){n=t.shift();const a=typeof n,o=Array.isArray(i);if(Array.isArray(n)){for(let l=0;l<n.length;l++)xr(i,[n[l]].concat(t),e);return}else if(o&&a==="function"){for(let l=0;l<i.length;l++)n(i[l],l)&&xr(i,[l].concat(t),e);return}else if(o&&a==="object"){const{from:l=0,to:c=i.length-1,by:f=1}=n;for(let u=l;u<=c;u+=f)xr(i,[u].concat(t),e);return}else if(t.length>1){xr(i[n],t,[n].concat(e));return}r=i[n],e=[n].concat(e)}let s=t[0];typeof s=="function"&&(s=s(r,e),s===r)||n===void 0&&s==null||(s=Ar(s),n===void 0||As(r)&&As(s)&&!Array.isArray(s)?ch(r,s):Rs(i,n,s))}function hh(...[i,t]){const e=Ar(i||{}),n=Array.isArray(e),r=oh(e);function s(...a){vr(()=>{n&&a.length===1?I0(e,a[0]):xr(e,a)})}return[r,s]}class fc{constructor(t){}}var L0=_n('<button class="btn btn-primary">End Draw Mode');class U0{instructions;disableOrbit=()=>!0;constructor(t){let e=pe(()=>t.canvasSize()!=null),n=pe(()=>t.pointerPos()!=null);On(zn([e,n,t.pointerDown],([s,a,o])=>{if(!s||!a||!o)return;let l=t.canvasSize,c=t.pointerPos,f,u;{let h=$e(l),p=$e(c);f=p.x-.5*h.x,u=-p.y+.5*h.y}N0(t.brickMap,f,u),t.updateSdf(),On(zn(c,h=>{let p=$e(l),g=h.x-.5*p.x,M=-h.y+.5*p.y,m=g-f,d=M-u;m*m+d*d<=25||(F0(t.brickMap,f,u,g,M),f=g,u=M,t.updateSdf())},{defer:!0}))}));let r=()=>(()=>{var s=L0();return s.$$click=()=>t.endMode(),s})();this.instructions=r}}function N0(i,t,e){let n=512+Math.round(t),r=512+Math.round(e),s=512,a=20;for(let o=-a-2;o<=a+2;++o)for(let l=-a-2;l<=a+2;++l)for(let c=-a-2;c<=a+2;++c){let f=Math.sqrt(o*o+l*l+c*c)-a;if(f/=Math.sqrt(3),f<-1||f>1)continue;let u=128-Math.floor(Math.max(-1,Math.min(1,f))*127);u<1&&(u=1),u>255&&(u=255);let h=n+c,p=r+l,g=s+o;h<0||h>=1024||p<0||p>=1024||g<0||g>=1024||i.set(h,p,g,u)}}function F0(i,t,e,n,r){let s=512+Math.round(t),a=512+Math.round(e),o=512,l=512+Math.round(n),c=512+Math.round(r),f=512,u=20,h=l-s,p=c-a,g=f-o,M=h*h+p*p+g*g,m=(A,C,_)=>{let v=((A-s)*h+(C-a)*p+(_-o)*g)/M;v=Math.max(0,Math.min(1,v));let P=s+h*v,N=a+p*v,O=o+g*v,V=A-P,G=C-N,k=_-O;return Math.sqrt(V*V+G*G+k*k)-u},d=Math.min(s,l)-u,y=Math.max(s,l)+u,E=Math.min(a,c)-u,b=Math.max(a,c)+u,T=Math.min(o,f)-u,R=Math.max(o,f)+u;for(let A=T-2;A<=R+2;++A)for(let C=E-2;C<=b+2;++C)for(let _=d-2;_<=y+2;++_){if(A<0||A>=1024||C<0||C>=1024||_<0||_>=1024)continue;let v=m(_,C,A);if(v/=Math.sqrt(3),v<-1||v>1)continue;let P=128-Math.floor(Math.max(-1,Math.min(1,v))*127);P<1&&(P=1),P>255&&(P=255);let N=i.get(_,C,A);N!=0&&(P=Math.max(P,N)),i.set(_,C,A,P)}}Ds(["click"]);class O0{value;constructor(t){this.value=t}}var B0=_n('<div><label class="label bg-base-100">Select a primitive to insert, OR select an existing primitive on the screen to transform:'),z0=_n('<button class="btn btn-primary">Sphere'),V0=_n('<button class="btn btn-primary ml-2">Cube'),k0=_n('<div><label class="label bg-base-100">Otherwise if your finish, press the I am finished button:'),G0=_n('<button class="btn btn-primary">I am finished'),H0=_n('<div><label class="label bg-base-100">Transform the primitive, then click place it:'),W0=_n('<button class="btn btn-primary">Place It');const zi=1500,as=1e3;class X0{instructions;overlayObject3D;useTransformControlOnObject3D;onClick;constructor(t){let[e,n]=hh({existingPrimitives:[],movingExistingPrimitive:void 0,insertingPrimitive:void 0});Mr(()=>{for(let h of e.existingPrimitives)h.value.cleanup();n("existingPrimitives",[])});let r=h=>{n("insertingPrimitive",h)},s=()=>{let h=o();h!=null?(h.autoCleanup=!1,vr(()=>{n("insertingPrimitive",void 0),n("existingPrimitives",p=>[...p,new O0({primitive:h.primitive,object:h.object,cleanup:h.cleanup})])})):e.movingExistingPrimitive!=null&&n("movingExistingPrimitive",void 0)},a=()=>{let h=[];for(let A of e.existingPrimitives){let C=A.value,_=C.object,v=new D,P=new we,N=new D;_.matrix.decompose(v,P,N);let O,V=new we;if(V.copy(P),V.conjugate(),C.primitive=="Sphere"){let G=new D(as,as,as).multiply(N),k=new D,L=new D,Y=new D().copy(G).multiply(G);O=J=>{k.copy(J),k.sub(v),k.applyQuaternion(V),L.copy(k),k.divide(G),L.divide(Y);let et=k.length(),it=L.length();return et*(et-1)/it}}else{let G=new D(zi,zi,zi).multiply(N).multiplyScalar(.5),k=new D,L=new D;O=Y=>{k.copy(Y),k.sub(v),k.applyQuaternion(V),L.copy(k),L.x=Math.abs(L.x),L.y=Math.abs(L.y),L.z=Math.abs(L.z),L.sub(G);let J=Math.min(Math.max(L.x,L.y,L.z),0);return L.x=Math.max(L.x,0),L.y=Math.max(L.y,0),L.z=Math.max(L.z,0),L.length()+J}}h.push(O)}let p=A=>{let C=h[0](A);for(let _=1;_<h.length;++_)C=Math.min(C,h[_](A));return C},g=new Si;{let A=!0,C=new Si;for(let _ of e.existingPrimitives){let v=_.value.object;v instanceof ft&&v.geometry instanceof Ue&&v.geometry.computeBoundingBox(),C.setFromObject(v),A?(g.copy(C),A=!1):g.union(C)}}let M=Math.sqrt(3),m=new D,d=Math.max(0,512+Math.floor(g.min.z/10))-1,y=Math.min(1023,512+Math.ceil(g.max.z/10))+1,E=Math.max(0,512+Math.floor(g.min.y/10))-1,b=Math.min(1023,512+Math.ceil(g.max.y/10))+1,T=Math.max(0,512+Math.floor(g.min.x/10))-1,R=Math.min(1023,512+Math.ceil(g.max.x/10))+1;for(let A=d;A<=y;++A){let C=(A-512)*10;for(let _=E;_<=b;++_){let v=(_-512)*10;for(let P=T;P<=R;++P){let N=(P-512)*10;m.set(N,v,C);let O=p(m)/(10*M),V=128-Math.floor(Math.max(-1,Math.min(1,O))*127);V<1&&(V=1),V>255&&(V=255),V=Math.max(V,t.brickMap.get(P,_,A)),t.brickMap.set(P,_,A,V)}}}t.updateSdf(),t.endMode()},o=pe(zn(()=>e.insertingPrimitive,h=>{if(h==null)return;let p,g=new $c({color:"blue"});switch(h){case"Cube":{p=new ve(zi,zi,zi);break}case"Sphere":{p=new Dr(as);break}default:throw new Error("Unreachable")}let M=new ft(p,g),m={primitive:h,autoCleanup:!0,cleanup:()=>{p.dispose(),g.dispose()},object:M};return Mr(()=>{m.autoCleanup&&m.cleanup()}),m})),l=()=>ei(Dh,{get children(){return[ei(Ko,{get when(){return Ih(()=>e.insertingPrimitive==null)()&&e.movingExistingPrimitive==null},get children(){return[B0(),(()=>{var h=z0();return h.$$click=()=>r("Sphere"),h})(),(()=>{var h=V0();return h.$$click=()=>r("Cube"),h})(),k0(),(()=>{var h=G0();return h.$$click=()=>a(),h})()]}}),ei(Ko,{get when(){return e.insertingPrimitive!=null||e.movingExistingPrimitive!=null},get children(){return[H0(),(()=>{var h=W0();return h.$$click=()=>s(),h})()]}})]}}),c=pe(()=>{let h=o()?.object;if(h==null&&e.existingPrimitives.length==0)return;let p=new pr;h!=null&&p.add(h);for(let g of e.existingPrimitives)p.add(g.value.object);return p}),f=pe(()=>o()?.object??e.movingExistingPrimitive),u=()=>{if(e.movingExistingPrimitive!=null||e.insertingPrimitive!=null)return;let h=t.pointerPos();if(h!=null){let p=new Set;for(let g of e.existingPrimitives)p.add(g.value.object);for(let g of t.getThreeObjectsUnderScreenCoords(h))if(p.has(g)){n("movingExistingPrimitive",g);break}}};this.instructions=l,this.overlayObject3D=c,this.useTransformControlOnObject3D=f,this.onClick=u}}Ds(["click"]);var Y0=_n('<button class="btn btn-primary">End Sculpt Mode');class q0{instructions;disableOrbit;overlayObject3D;constructor(t){let e=new rh().copy(t.brickMap),n=pe(()=>{let u=t.pointerPos();if(u==null)return;let h=new Cr;return t.screenCoordsToRay(u,h),h}),r=pe(()=>{let u=n();if(u==null)return;let h=[0];return e.march(u.origin,u.direction,h)?new D().copy(u.direction).multiplyScalar(h[0]).add(u.origin):void 0});On(zn(t.pointerDown,u=>{if(!u){e.copy(t.brickMap);return}let h=pe(()=>r()!=null);On(zn(h,p=>{if(!p)return;let g=r;j0(t.brickMap,g()),t.updateSdf();let M=g();On(zn(g,m=>{M.distanceTo(m)<15||($0(t.brickMap,M,m),t.updateSdf(),M=m)},{defer:!0}))}))},{defer:!0}));let s=new Dr(40),a=new $c({color:"blue"});Mr(()=>{s.dispose(),a.dispose()});let o=new ft(s,a),l=()=>(()=>{var u=Y0();return u.$$click=()=>t.endMode(),u})(),c=pe(()=>r()!=null),f=pe(()=>{let u=r();if(u==null){t.rerender();return}return o.position.copy(u),o.updateMatrix(),o.matrixWorldNeedsUpdate=!0,t.rerender(),o});this.instructions=l,this.disableOrbit=c,this.overlayObject3D=f}}function j0(i,t){let e=512+Math.round(t.x/10),n=512+Math.round(t.y/10),r=512+Math.round(t.z/10),s=4;for(let a=-s-2;a<=s+2;++a)for(let o=-s-2;o<=s+2;++o)for(let l=-s-2;l<=s+2;++l){let c=e+l,f=n+o,u=r+a;if(c<0||c>=1024||f<0||f>=1024||u<0||u>=1024)continue;let h=Math.sqrt(a*a+o*o+l*l)-s;h/=Math.sqrt(3);let p=i.get(c,f,u),g=128-Math.floor(Math.max(-1,Math.min(1,-h))*127);g=Math.min(g,p),g<1&&(g=1),g>255&&(g=255),i.set(c,f,u,g)}}function $0(i,t,e){let n=512+Math.round(t.x/10),r=512+Math.round(t.y/10),s=512+Math.round(t.z/10),a=512+Math.round(e.x/10),o=512+Math.round(e.y/10),l=512+Math.round(e.z/10),c=4,f=a-n,u=o-r,h=l-s,p=f*f+u*u+h*h,g=(T,R,A)=>{let C=((T-n)*f+(R-r)*u+(A-s)*h)/p;C=Math.max(0,Math.min(1,C));let _=n+f*C,v=r+u*C,P=s+h*C,N=T-_,O=R-v,V=A-P;return Math.sqrt(N*N+O*O+V*V)-c},M=Math.min(n,a)-c,m=Math.max(n,a)+c,d=Math.min(r,o)-c,y=Math.max(r,o)+c,E=Math.min(s,l)-c,b=Math.max(s,l)+c;for(let T=E-2;T<=b+2;++T)for(let R=d-2;R<=y+2;++R)for(let A=M-2;A<=m+2;++A){if(T<0||T>=1024||R<0||R>=1024||A<0||A>=1024)continue;let C=g(A,R,T);C/=Math.sqrt(3);let _=128-Math.floor(Math.max(-1,Math.min(1,-C))*127);_<1&&(_=1),_>255&&(_=255);let v=i.get(A,R,T);_=Math.min(_,v),i.set(A,R,T,_)}}Ds(["click"]);var Z0=_n('<div><div style=touch-action:none></div><div class="ml-2 mt-2"><div><button class="btn btn-primary">Insert Primitive</button><button class="btn btn-primary ml-2">Draw</button><button class="btn btn-primary ml-2">Sculpt</button><button class="btn btn-primary ml-2">Spin</button><button class="btn btn-primary ml-2">Move</button><button class="btn btn-primary ml-2">Rotate</button><button class="btn btn-primary ml-2">Scale</button><div class=join><label class=label>Px<input type=radio name=PxSize class="btn btn-sm join-item"aria-label=1x><input type=radio name=PxSize class="btn btn-sm join-item"aria-label=2x><input type=radio name=PxSize class="btn btn-sm join-item"aria-label=4x>');const K0=()=>{let[i,t]=hh({mkMode:fc,pointerPos:void 0,pointerDown:!1,pixelSize:1}),e=new rh,[n,r]=fn(),s=_=>t("mkMode",()=>_),a={endMode:()=>s(fc),brickMap:e,canvasSize:()=>n()?.canvasSize(),pointerPos:()=>i.pointerPos,pointerDown:()=>i.pointerDown,updateSdf:()=>{n()?.onBrickMapChanged()},rerender:()=>{n()?.rerender()},screenCoordsToRay(_,v){n()?.screenCoordsToRay(_,v)},*getThreeObjectsUnderScreenCoords(_){let v=n()?.getThreeObjectsUnderScreenCoords(_);v!=null&&(yield*v)}},o=pe(()=>new i.mkMode(a)),l=()=>ei(Ph,{get when(){return o().instructions},keyed:!0,children:_=>ei(_,{})}),c=pe(()=>o().disableOrbit?.()??!1),f=pe(()=>o().overlayObject3D?.()),u=pe(()=>o().useTransformControlOnObject3D?.()),[h,p]=fn(),[g,M]=fn(!1),m,d=_=>{if(g())return;let v=h();if(v==null)return;v.setPointerCapture(_.pointerId);let P=v.getBoundingClientRect(),N=_.clientX-P.left,O=_.clientY-P.top;vr(()=>{t("pointerPos",new At(N,O)),t("pointerDown",!0)}),m=performance.now()},y=_=>{if(g())return;let v=h();if(v==null)return;v.setPointerCapture(_.pointerId);let P=v.getBoundingClientRect(),N=_.clientX-P.left,O=_.clientY-P.top;t("pointerPos",new At(N,O))},E=_=>{if(g())return;let v=h();if(v==null)return;let P;m!=null&&(P=performance.now()-m),m=void 0,v.releasePointerCapture(_.pointerId);let N=v.getBoundingClientRect();_.clientX-N.left,_.clientY-N.top,vr(()=>{t("pointerDown",!1)}),P!=null&&P<300&&b()},b=()=>{o().onClick?.()},T=()=>{requestAnimationFrame(()=>{})},R=()=>{n()?.moveTransform()},A=()=>{n()?.rotateTransform()},C=()=>{n()?.scaleTransform()};return(()=>{var _=Z0(),v=_.firstChild,P=v.nextSibling,N=P.firstChild,O=N.firstChild,V=O.nextSibling,G=V.nextSibling,k=G.nextSibling,L=k.nextSibling,Y=L.nextSibling,J=Y.nextSibling,et=J.nextSibling,it=et.firstChild,Pt=it.firstChild,Dt=Pt.nextSibling,qt=Dt.nextSibling,te=qt.nextSibling;en(_,"position","relative"),en(_,"width","100%"),en(_,"height","100%"),v.$$pointerup=E,v.$$pointermove=y,v.$$pointerdown=d;var j=p;return typeof j=="function"?Sc(j,v):p=v,en(v,"position","absolute"),en(v,"left","0"),en(v,"top","0"),en(v,"right","0"),en(v,"bottom","0"),Aa(v,ei(R0,{brickMap:e,onDragingEvent:$=>{M($)},onInit:$=>{r($)},get disableOrbit(){return c()},get overlayObject3D(){return f()},get useTransformControlOnObject3D(){return u()},get pixelSize(){return i.pixelSize}})),en(P,"position","absolute"),en(P,"left","0"),en(P,"top","0"),O.$$click=()=>s(X0),V.$$click=()=>s(U0),G.$$click=()=>s(q0),k.$$click=()=>T(),L.$$click=()=>R(),Y.$$click=()=>A(),J.$$click=()=>C(),Dt.addEventListener("change",$=>{$.currentTarget.checked&&t("pixelSize",1)}),qt.addEventListener("change",$=>{$.currentTarget.checked&&t("pixelSize",2)}),te.addEventListener("change",$=>{$.currentTarget.checked&&t("pixelSize",4)}),Aa(P,ei(l,{}),null),Gi(()=>Dt.checked=i.pixelSize==1),Gi(()=>qt.checked=i.pixelSize==2),Gi(()=>te.checked=i.pixelSize==4),_})()};Ds(["pointerdown","pointermove","pointerup","click"]);const J0=document.getElementById("root");Uh(()=>ei(K0,{}),J0);
