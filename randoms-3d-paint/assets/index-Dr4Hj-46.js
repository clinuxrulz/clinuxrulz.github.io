...
`)}const r_={[Cc]:"Linear",[Pc]:"Reinhard",[Dc]:"Cineon",[Ic]:"ACESFilmic",[Uc]:"AgX",[Nc]:"Neutral",[Lc]:"Custom"};function s_(i,t){const e=r_[t];return e===void 0?(Pt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const ns=new D;function a_(){Yt.getLuminanceCoefficients(ns);const i=ns.x.toFixed(4),t=ns.y.toFixed(4),e=ns.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
}`;class $_{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){const n=new th(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new Mn({vertexShader:q_,fragmentShader:j_,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new ut(new Ir(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Z_ extends bi{constructor(t,e){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,f=null,d=null,h=null,p=null,_=null;const x=typeof XRWebGLBinding<"u",m=new $_,u={},S=e.getContextAttributes();let E=null,b=null;const A=[],C=[],R=new wt;let P=null;const g=new fn;g.viewport=new _e;const M=new fn;M.viewport=new _e;const T=[g,M],I=new af;let U=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(j){let K=A[j];return K===void 0&&(K=new da,A[j]=K),K.getTargetRaySpace()},this.getControllerGrip=function(j){let K=A[j];return K===void 0&&(K=new da,A[j]=K),K.getGripSpace()},this.getHand=function(j){let K=A[j];return K===void 0&&(K=new da,A[j]=K),K.getHandSpace()};function V(j){const K=C.indexOf(j.inputSource);if(K===-1)return;const rt=A[K];rt!==void 0&&(rt.update(j.inputSource,j.frame,c||a),rt.dispatchEvent({type:j.type,data:j.inputSource}))}function G(){r.removeEventListener("select",V),r.removeEventListener("selectstart",V),r.removeEventListener("selectend",V),r.removeEventListener("squeeze",V),r.removeEventListener("squeezestart",V),r.removeEventListener("squeezeend",V),r.removeEventListener("end",G),r.removeEventListener("inputsourceschange",N);for(let j=0;j<A.length;j++){const K=C[j];K!==null&&(C[j]=null,A[j].disconnect(K))}U=null,z=null,m.reset();for(const j in u)delete u[j];t.setRenderTarget(E),p=null,h=null,d=null,r=null,b=null,ee.stop(),n.isPresenting=!1,t.setPixelRatio(P),t.setSize(R.width,R.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(j){s=j,n.isPresenting===!0&&Pt("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(j){o=j,n.isPresenting===!0&&Pt("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(j){c=j},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return d===null&&x&&(d=new XRWebGLBinding(r,e)),d},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(j){if(r=j,r!==null){if(E=t.getRenderTarget(),r.addEventListener("select",V),r.addEventListener("selectstart",V),r.addEventListener("selectend",V),r.addEventListener("squeeze",V),r.addEventListener("squeezestart",V),r.addEventListener("squeezeend",V),r.addEventListener("end",G),r.addEventListener("inputsourceschange",N),S.xrCompatible!==!0&&await e.makeXRCompatible(),P=t.getPixelRatio(),t.getSize(R),x&&"createProjectionLayer"in XRWebGLBinding.prototype){let rt=null,Ut=null,vt=null;S.depth&&(vt=S.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,rt=S.stencil?Mi:Xn,Ut=S.stencil?Tr:In);const jt={colorFormat:e.RGBA8,depthFormat:vt,scaleFactor:s};d=this.getBinding(),h=d.createProjectionLayer(jt),r.updateRenderState({layers:[h]}),t.setPixelRatio(1),t.setSize(h.textureWidth,h.textureHeight,!1),b=new Pn(h.textureWidth,h.textureHeight,{format:ln,type:Ge,depthTexture:new wr(h.textureWidth,h.textureHeight,Ut,void 0,void 0,void 0,void 0,void 0,void 0,rt),stencilBuffer:S.stencil,colorSpace:t.outputColorSpace,samples:S.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const rt={antialias:S.antialias,alpha:!0,depth:S.depth,stencil:S.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,e,rt),r.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),b=new Pn(p.framebufferWidth,p.framebufferHeight,{format:ln,type:Ge,colorSpace:t.outputColorSpace,stencilBuffer:S.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),ee.setContext(r),ee.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function N(j){for(let K=0;K<j.removed.length;K++){const rt=j.removed[K],Ut=C.indexOf(rt);Ut>=0&&(C[Ut]=null,A[Ut].disconnect(rt))}for(let K=0;K<j.added.length;K++){const rt=j.added[K];let Ut=C.indexOf(rt);if(Ut===-1){for(let jt=0;jt<A.length;jt++)if(jt>=C.length){C.push(rt),Ut=jt;break}else if(C[jt]===null){C[jt]=rt,Ut=jt;break}if(Ut===-1)break}const vt=A[Ut];vt&&vt.connect(rt)}}const Y=new D,J=new D;function et(j,K,rt){Y.setFromMatrixPosition(K.matrixWorld),J.setFromMatrixPosition(rt.matrixWorld);const Ut=Y.distanceTo(J),vt=K.projectionMatrix.elements,jt=rt.projectionMatrix.elements,Le=vt[14]/(vt[10]-1),Wt=vt[14]/(vt[10]+1),ne=(vt[9]+1)/vt[5],le=(vt[9]-1)/vt[5],Bt=(vt[8]-1)/vt[0],Se=(jt[8]+1)/jt[0],L=Le*Bt,ye=Le*Se,Jt=Ut/(-Bt+Se),ue=Jt*-Bt;if(K.matrixWorld.decompose(j.position,j.quaternion,j.scale),j.translateX(ue),j.translateZ(Jt),j.matrixWorld.compose(j.position,j.quaternion,j.scale),j.matrixWorldInverse.copy(j.matrixWorld).invert(),vt[10]===-1)j.projectionMatrix.copy(K.projectionMatrix),j.projectionMatrixInverse.copy(K.projectionMatrixInverse);else{const St=Le+Jt,w=Wt+Jt,v=L-ue,O=ye+(Ut-ue),q=ne*Wt/w*St,Z=le*Wt/w*St;j.projectionMatrix.makePerspective(v,O,q,Z,St,w),j.projectionMatrixInverse.copy(j.projectionMatrix).invert()}}function it(j,K){K===null?j.matrixWorld.copy(j.matrix):j.matrixWorld.multiplyMatrices(K.matrixWorld,j.matrix),j.matrixWorldInverse.copy(j.matrixWorld).invert()}this.updateCamera=function(j){if(r===null)return;let K=j.near,rt=j.far;m.texture!==null&&(m.depthNear>0&&(K=m.depthNear),m.depthFar>0&&(rt=m.depthFar)),I.near=M.near=g.near=K,I.far=M.far=g.far=rt,(U!==I.near||z!==I.far)&&(r.updateRenderState({depthNear:I.near,depthFar:I.far}),U=I.near,z=I.far),I.layers.mask=j.layers.mask|6,g.layers.mask=I.layers.mask&3,M.layers.mask=I.layers.mask&5;const Ut=j.parent,vt=I.cameras;it(I,Ut);for(let jt=0;jt<vt.length;jt++)it(vt[jt],Ut);vt.length===2?et(I,g,M):I.projectionMatrix.copy(g.projectionMatrix),Dt(j,I,Ut)};function Dt(j,K,rt){rt===null?j.matrix.copy(K.matrixWorld):(j.matrix.copy(rt.matrixWorld),j.matrix.invert(),j.matrix.multiply(K.matrixWorld)),j.matrix.decompose(j.position,j.quaternion,j.scale),j.updateMatrixWorld(!0),j.projectionMatrix.copy(K.projectionMatrix),j.projectionMatrixInverse.copy(K.projectionMatrixInverse),j.isPerspectiveCamera&&(j.fov=yo*2*Math.atan(1/j.projectionMatrix.elements[5]),j.zoom=1)}this.getCamera=function(){return I},this.getFoveation=function(){if(!(h===null&&p===null))return l},this.setFoveation=function(j){l=j,h!==null&&(h.fixedFoveation=j),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=j)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(I)},this.getCameraTexture=function(j){return u[j]};let Lt=null;function Kt(j,K){if(f=K.getViewerPose(c||a),_=K,f!==null){const rt=f.views;p!==null&&(t.setRenderTargetFramebuffer(b,p.framebuffer),t.setRenderTarget(b));let Ut=!1;rt.length!==I.cameras.length&&(I.cameras.length=0,Ut=!0);for(let Wt=0;Wt<rt.length;Wt++){const ne=rt[Wt];let le=null;if(p!==null)le=p.getViewport(ne);else{const Se=d.getViewSubImage(h,ne);le=Se.viewport,Wt===0&&(t.setRenderTargetTextures(b,Se.colorTexture,Se.depthStencilTexture),t.setRenderTarget(b))}let Bt=T[Wt];Bt===void 0&&(Bt=new fn,Bt.layers.enable(Wt),Bt.viewport=new _e,T[Wt]=Bt),Bt.matrix.fromArray(ne.transform.matrix),Bt.matrix.decompose(Bt.position,Bt.quaternion,Bt.scale),Bt.projectionMatrix.fromArray(ne.projectionMatrix),Bt.projectionMatrixInverse.copy(Bt.projectionMatrix).invert(),Bt.viewport.set(le.x,le.y,le.width,le.height),Wt===0&&(I.matrix.copy(Bt.matrix),I.matrix.decompose(I.position,I.quaternion,I.scale)),Ut===!0&&I.cameras.push(Bt)}const vt=r.enabledFeatures;if(vt&&vt.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&x){d=n.getBinding();const Wt=d.getDepthInformation(rt[0]);Wt&&Wt.isValid&&Wt.texture&&m.init(Wt,r.renderState)}if(vt&&vt.includes("camera-access")&&x){t.state.unbindTexture(),d=n.getBinding();for(let Wt=0;Wt<rt.length;Wt++){const ne=rt[Wt].camera;if(ne){let le=u[ne];le||(le=new th,u[ne]=le);const Bt=d.getCameraImage(ne);le.sourceTexture=Bt}}}}for(let rt=0;rt<A.length;rt++){const Ut=C[rt],vt=A[rt];Ut!==null&&vt!==void 0&&vt.update(Ut,K,c||a)}Lt&&Lt(j,K),K.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:K}),_=null}const ee=new nh;ee.setAnimationLoop(Kt),this.setAnimationLoop=function(j){Lt=j},this.dispose=function(){}}}const di=new vn,K_=new te;function J_(i,t){function e(m,u){m.matrixAutoUpdate===!0&&m.updateMatrix(),u.value.copy(m.matrix)}function n(m,u){u.color.getRGB(m.fogColor.value,$c(i)),u.isFog?(m.fogNear.value=u.near,m.fogFar.value=u.far):u.isFogExp2&&(m.fogDensity.value=u.density)}function r(m,u,S,E,b){u.isMeshBasicMaterial||u.isMeshLambertMaterial?s(m,u):u.isMeshToonMaterial?(s(m,u),d(m,u)):u.isMeshPhongMaterial?(s(m,u),f(m,u)):u.isMeshStandardMaterial?(s(m,u),h(m,u),u.isMeshPhysicalMaterial&&p(m,u,b)):u.isMeshMatcapMaterial?(s(m,u),_(m,u)):u.isMeshDepthMaterial?s(m,u):u.isMeshDistanceMaterial?(s(m,u),x(m,u)):u.isMeshNormalMaterial?s(m,u):u.isLineBasicMaterial?(a(m,u),u.isLineDashedMaterial&&o(m,u)):u.isPointsMaterial?l(m,u,S,E):u.isSpriteMaterial?c(m,u):u.isShadowMaterial?(m.color.value.copy(u.color),m.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(m,u){m.opacity.value=u.opacity,u.color&&m.diffuse.value.copy(u.color),u.emissive&&m.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(m.map.value=u.map,e(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,e(u.alphaMap,m.alphaMapTransform)),u.bumpMap&&(m.bumpMap.value=u.bumpMap,e(u.bumpMap,m.bumpMapTransform),m.bumpScale.value=u.bumpScale,u.side===tn&&(m.bumpScale.value*=-1)),u.normalMap&&(m.normalMap.value=u.normalMap,e(u.normalMap,m.normalMapTransform),m.normalScale.value.copy(u.normalScale),u.side===tn&&m.normalScale.value.negate()),u.displacementMap&&(m.displacementMap.value=u.displacementMap,e(u.displacementMap,m.displacementMapTransform),m.displacementScale.value=u.displacementScale,m.displacementBias.value=u.displacementBias),u.emissiveMap&&(m.emissiveMap.value=u.emissiveMap,e(u.emissiveMap,m.emissiveMapTransform)),u.specularMap&&(m.specularMap.value=u.specularMap,e(u.specularMap,m.specularMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest);const S=t.get(u),E=S.envMap,b=S.envMapRotation;E&&(m.envMap.value=E,di.copy(b),di.x*=-1,di.y*=-1,di.z*=-1,E.isCubeTexture&&E.isRenderTargetTexture===!1&&(di.y*=-1,di.z*=-1),m.envMapRotation.value.setFromMatrix4(K_.makeRotationFromEuler(di)),m.flipEnvMap.value=E.isCubeTexture&&E.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=u.reflectivity,m.ior.value=u.ior,m.refractionRatio.value=u.refractionRatio),u.lightMap&&(m.lightMap.value=u.lightMap,m.lightMapIntensity.value=u.lightMapIntensity,e(u.lightMap,m.lightMapTransform)),u.aoMap&&(m.aoMap.value=u.aoMap,m.aoMapIntensity.value=u.aoMapIntensity,e(u.aoMap,m.aoMapTransform))}function a(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,u.map&&(m.map.value=u.map,e(u.map,m.mapTransform))}function o(m,u){m.dashSize.value=u.dashSize,m.totalSize.value=u.dashSize+u.gapSize,m.scale.value=u.scale}function l(m,u,S,E){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.size.value=u.size*S,m.scale.value=E*.5,u.map&&(m.map.value=u.map,e(u.map,m.uvTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,e(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function c(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.rotation.value=u.rotation,u.map&&(m.map.value=u.map,e(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,e(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function f(m,u){m.specular.value.copy(u.specular),m.shininess.value=Math.max(u.shininess,1e-4)}function d(m,u){u.gradientMap&&(m.gradientMap.value=u.gradientMap)}function h(m,u){m.metalness.value=u.metalness,u.metalnessMap&&(m.metalnessMap.value=u.metalnessMap,e(u.metalnessMap,m.metalnessMapTransform)),m.roughness.value=u.roughness,u.roughnessMap&&(m.roughnessMap.value=u.roughnessMap,e(u.roughnessMap,m.roughnessMapTransform)),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)}function p(m,u,S){m.ior.value=u.ior,u.sheen>0&&(m.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),m.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(m.sheenColorMap.value=u.sheenColorMap,e(u.sheenColorMap,m.sheenColorMapTransform)),u.sheenRoughnessMap&&(m.sheenRoughnessMap.value=u.sheenRoughnessMap,e(u.sheenRoughnessMap,m.sheenRoughnessMapTransform))),u.clearcoat>0&&(m.clearcoat.value=u.clearcoat,m.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(m.clearcoatMap.value=u.clearcoatMap,e(u.clearcoatMap,m.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,e(u.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(m.clearcoatNormalMap.value=u.clearcoatNormalMap,e(u.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===tn&&m.clearcoatNormalScale.value.negate())),u.dispersion>0&&(m.dispersion.value=u.dispersion),u.iridescence>0&&(m.iridescence.value=u.iridescence,m.iridescenceIOR.value=u.iridescenceIOR,m.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(m.iridescenceMap.value=u.iridescenceMap,e(u.iridescenceMap,m.iridescenceMapTransform)),u.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=u.iridescenceThicknessMap,e(u.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),u.transmission>0&&(m.transmission.value=u.transmission,m.transmissionSamplerMap.value=S.texture,m.transmissionSamplerSize.value.set(S.width,S.height),u.transmissionMap&&(m.transmissionMap.value=u.transmissionMap,e(u.transmissionMap,m.transmissionMapTransform)),m.thickness.value=u.thickness,u.thicknessMap&&(m.thicknessMap.value=u.thicknessMap,e(u.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=u.attenuationDistance,m.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(m.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(m.anisotropyMap.value=u.anisotropyMap,e(u.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=u.specularIntensity,m.specularColor.value.copy(u.specularColor),u.specularColorMap&&(m.specularColorMap.value=u.specularColorMap,e(u.specularColorMap,m.specularColorMapTransform)),u.specularIntensityMap&&(m.specularIntensityMap.value=u.specularIntensityMap,e(u.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,u){u.matcap&&(m.matcap.value=u.matcap)}function x(m,u){const S=t.get(u).light;m.referencePosition.value.setFromMatrixPosition(S.matrixWorld),m.nearDistance.value=S.shadow.camera.near,m.farDistance.value=S.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Q_(i,t,e,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(S,E){const b=E.program;n.uniformBlockBinding(S,b)}function c(S,E){let b=r[S.id];b===void 0&&(_(S),b=f(S),r[S.id]=b,S.addEventListener("dispose",m));const A=E.program;n.updateUBOMapping(S,A);const C=t.render.frame;s[S.id]!==C&&(h(S),s[S.id]=C)}function f(S){const E=d();S.__bindingPointIndex=E;const b=i.createBuffer(),A=S.__size,C=S.usage;return i.bindBuffer(i.UNIFORM_BUFFER,b),i.bufferData(i.UNIFORM_BUFFER,A,C),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,E,b),b}function d(){for(let S=0;S<o;S++)if(a.indexOf(S)===-1)return a.push(S),S;return Xt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(S){const E=r[S.id],b=S.uniforms,A=S.__cache;i.bindBuffer(i.UNIFORM_BUFFER,E);for(let C=0,R=b.length;C<R;C++){const P=Array.isArray(b[C])?b[C]:[b[C]];for(let g=0,M=P.length;g<M;g++){const T=P[g];if(p(T,C,g,A)===!0){const I=T.__offset,U=Array.isArray(T.value)?T.value:[T.value];let z=0;for(let V=0;V<U.length;V++){const G=U[V],N=x(G);typeof G=="number"||typeof G=="boolean"?(T.__data[0]=G,i.bufferSubData(i.UNIFORM_BUFFER,I+z,T.__data)):G.isMatrix3?(T.__data[0]=G.elements[0],T.__data[1]=G.elements[1],T.__data[2]=G.elements[2],T.__data[3]=0,T.__data[4]=G.elements[3],T.__data[5]=G.elements[4],T.__data[6]=G.elements[5],T.__data[7]=0,T.__data[8]=G.elements[6],T.__data[9]=G.elements[7],T.__data[10]=G.elements[8],T.__data[11]=0):(G.toArray(T.__data,z),z+=N.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,I,T.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(S,E,b,A){const C=S.value,R=E+"_"+b;if(A[R]===void 0)return typeof C=="number"||typeof C=="boolean"?A[R]=C:A[R]=C.clone(),!0;{const P=A[R];if(typeof C=="number"||typeof C=="boolean"){if(P!==C)return A[R]=C,!0}else if(P.equals(C)===!1)return P.copy(C),!0}return!1}function _(S){const E=S.uniforms;let b=0;const A=16;for(let R=0,P=E.length;R<P;R++){const g=Array.isArray(E[R])?E[R]:[E[R]];for(let M=0,T=g.length;M<T;M++){const I=g[M],U=Array.isArray(I.value)?I.value:[I.value];for(let z=0,V=U.length;z<V;z++){const G=U[z],N=x(G),Y=b%A,J=Y%N.boundary,et=Y+J;b+=J,et!==0&&A-et<N.storage&&(b+=A-et),I.__data=new Float32Array(N.storage/Float32Array.BYTES_PER_ELEMENT),I.__offset=b,b+=N.storage}}}const C=b%A;return C>0&&(b+=A-C),S.__size=b,S.__cache={},this}function x(S){const E={boundary:0,storage:0};return typeof S=="number"||typeof S=="boolean"?(E.boundary=4,E.storage=4):S.isVector2?(E.boundary=8,E.storage=8):S.isVector3||S.isColor?(E.boundary=16,E.storage=12):S.isVector4?(E.boundary=16,E.storage=16):S.isMatrix3?(E.boundary=48,E.storage=48):S.isMatrix4?(E.boundary=64,E.storage=64):S.isTexture?Pt("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Pt("WebGLRenderer: Unsupported uniform value type.",S),E}function m(S){const E=S.target;E.removeEventListener("dispose",m);const b=a.indexOf(E.__bindingPointIndex);a.splice(b,1),i.deleteBuffer(r[E.id]),delete r[E.id],delete s[E.id]}function u(){for(const S in r)i.deleteBuffer(r[S]);a=[],r={},s={}}return{bind:l,update:c,dispose:u}}const t0=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let yn=null;function e0(){return yn===null&&(yn=new qu(t0,16,16,Ki,Wn),yn.name="DFG_LUT",yn.minFilter=be,yn.magFilter=be,yn.wrapS=Ne,yn.wrapT=Ne,yn.generateMipmaps=!1,yn.needsUpdate=!0),yn}class n0{constructor(t={}){const{canvas:e=Mu(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:f="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:h=!1,outputBufferType:p=Ge}=t;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=a;const x=p,m=new Set([No,Uo,Lo]),u=new Set([Ge,In,br,Tr,Po,Do]),S=new Uint32Array(4),E=new Int32Array(4);let b=null,A=null;const C=[],R=[];let P=null;this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Cn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const g=this;let M=!1;this._outputColorSpace=un;let T=0,I=0,U=null,z=-1,V=null;const G=new _e,N=new _e;let Y=null;const J=new qt(0);let et=0,it=e.width,Dt=e.height,Lt=1,Kt=null,ee=null;const j=new _e(0,0,it,Dt),K=new _e(0,0,it,Dt);let rt=!1;const Ut=new ko;let vt=!1,jt=!1;const Le=new te,Wt=new D,ne=new _e,le={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Bt=!1;function Se(){return U===null?Lt:1}let L=n;function ye(y,B){return e.getContext(y,B)}try{const y={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:f,failIfMajorPerformanceCaveat:d};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Ro}`),e.addEventListener("webglcontextlost",It,!1),e.addEventListener("webglcontextrestored",fe,!1),e.addEventListener("webglcontextcreationerror",ie,!1),L===null){const B="webgl2";if(L=ye(B,y),L===null)throw ye(B)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(y){throw Xt("WebGLRenderer: "+y.message),y}let Jt,ue,St,w,v,O,q,Z,X,Et,at,Mt,Ct,tt,lt,gt,yt,ot,zt,F,dt,nt,pt,Q;function $(){Jt=new em(L),Jt.init(),nt=new Y_(L,Jt),ue=new Yp(L,Jt,t,nt),St=new W_(L,Jt),ue.reversedDepthBuffer&&h&&St.buffers.depth.setReversed(!0),w=new rm(L),v=new C_,O=new X_(L,Jt,St,v,ue,nt,w),q=new jp(g),Z=new tm(g),X=new lf(L),pt=new Wp(L,X),Et=new nm(L,X,w,pt),at=new am(L,Et,X,w),zt=new sm(L,ue,O),gt=new qp(v),Mt=new R_(g,q,Z,Jt,ue,pt,gt),Ct=new J_(g,v),tt=new D_,lt=new O_(Jt),ot=new Hp(g,q,Z,St,at,_,l),yt=new G_(g,at,ue),Q=new Q_(L,w,ue,St),F=new Xp(L,Jt,w),dt=new im(L,Jt,w),w.programs=Mt.programs,g.capabilities=ue,g.extensions=Jt,g.properties=v,g.renderLists=tt,g.shadowMap=yt,g.state=St,g.info=w}$(),x!==Ge&&(P=new lm(x,e.width,e.height,r,s));const st=new Z_(g,L);this.xr=st,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){const y=Jt.get("WEBGL_lose_context");y&&y.loseContext()},this.forceContextRestore=function(){const y=Jt.get("WEBGL_lose_context");y&&y.restoreContext()},this.getPixelRatio=function(){return Lt},this.setPixelRatio=function(y){y!==void 0&&(Lt=y,this.setSize(it,Dt,!1))},this.getSize=function(y){return y.set(it,Dt)},this.setSize=function(y,B,W=!0){if(st.isPresenting){Pt("WebGLRenderer: Can't change size while VR device is presenting.");return}it=y,Dt=B,e.width=Math.floor(y*Lt),e.height=Math.floor(B*Lt),W===!0&&(e.style.width=y+"px",e.style.height=B+"px"),P!==null&&P.setSize(e.width,e.height),this.setViewport(0,0,y,B)},this.getDrawingBufferSize=function(y){return y.set(it*Lt,Dt*Lt).floor()},this.setDrawingBufferSize=function(y,B,W){it=y,Dt=B,Lt=W,e.width=Math.floor(y*W),e.height=Math.floor(B*W),this.setViewport(0,0,y,B)},this.setEffects=function(y){if(x===Ge){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(y){for(let B=0;B<y.length;B++)if(y[B].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}P.setEffects(y||[])},this.getCurrentViewport=function(y){return y.copy(G)},this.getViewport=function(y){return y.copy(j)},this.setViewport=function(y,B,W,H){y.isVector4?j.set(y.x,y.y,y.z,y.w):j.set(y,B,W,H),St.viewport(G.copy(j).multiplyScalar(Lt).round())},this.getScissor=function(y){return y.copy(K)},this.setScissor=function(y,B,W,H){y.isVector4?K.set(y.x,y.y,y.z,y.w):K.set(y,B,W,H),St.scissor(N.copy(K).multiplyScalar(Lt).round())},this.getScissorTest=function(){return rt},this.setScissorTest=function(y){St.setScissorTest(rt=y)},this.setOpaqueSort=function(y){Kt=y},this.setTransparentSort=function(y){ee=y},this.getClearColor=function(y){return y.copy(ot.getClearColor())},this.setClearColor=function(){ot.setClearColor(...arguments)},this.getClearAlpha=function(){return ot.getClearAlpha()},this.setClearAlpha=function(){ot.setClearAlpha(...arguments)},this.clear=function(y=!0,B=!0,W=!0){let H=0;if(y){let k=!1;if(U!==null){const ct=U.texture.format;k=m.has(ct)}if(k){const ct=U.texture.type,mt=u.has(ct),ft=ot.getClearColor(),_t=ot.getClearAlpha(),bt=ft.r,Rt=ft.g,Tt=ft.b;mt?(S[0]=bt,S[1]=Rt,S[2]=Tt,S[3]=_t,L.clearBufferuiv(L.COLOR,0,S)):(E[0]=bt,E[1]=Rt,E[2]=Tt,E[3]=_t,L.clearBufferiv(L.COLOR,0,E))}else H|=L.COLOR_BUFFER_BIT}B&&(H|=L.DEPTH_BUFFER_BIT),W&&(H|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),L.clear(H)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",It,!1),e.removeEventListener("webglcontextrestored",fe,!1),e.removeEventListener("webglcontextcreationerror",ie,!1),ot.dispose(),tt.dispose(),lt.dispose(),v.dispose(),q.dispose(),Z.dispose(),at.dispose(),pt.dispose(),Q.dispose(),Mt.dispose(),st.dispose(),st.removeEventListener("sessionstart",qo),st.removeEventListener("sessionend",jo),ai.stop()};function It(y){y.preventDefault(),dl("WebGLRenderer: Context Lost."),M=!0}function fe(){dl("WebGLRenderer: Context Restored."),M=!1;const y=w.autoReset,B=yt.enabled,W=yt.autoUpdate,H=yt.needsUpdate,k=yt.type;$(),w.autoReset=y,yt.enabled=B,yt.autoUpdate=W,yt.needsUpdate=H,yt.type=k}function ie(y){Xt("WebGLRenderer: A WebGL context could not be created. Reason: ",y.statusMessage)}function Sn(y){const B=y.target;B.removeEventListener("dispose",Sn),Ln(B)}function Ln(y){xh(y),v.remove(y)}function xh(y){const B=v.get(y).programs;B!==void 0&&(B.forEach(function(W){Mt.releaseProgram(W)}),y.isShaderMaterial&&Mt.releaseShaderCache(y))}this.renderBufferDirect=function(y,B,W,H,k,ct){B===null&&(B=le);const mt=k.isMesh&&k.matrixWorld.determinant()<0,ft=Mh(y,B,W,H,k);St.setMaterial(H,mt);let _t=W.index,bt=1;if(H.wireframe===!0){if(_t=Et.getWireframeAttribute(W),_t===void 0)return;bt=2}const Rt=W.drawRange,Tt=W.attributes.position;let kt=Rt.start*bt,ae=(Rt.start+Rt.count)*bt;ct!==null&&(kt=Math.max(kt,ct.start*bt),ae=Math.min(ae,(ct.start+ct.count)*bt)),_t!==null?(kt=Math.max(kt,0),ae=Math.min(ae,_t.count)):Tt!=null&&(kt=Math.max(kt,0),ae=Math.min(ae,Tt.count));const ge=ae-kt;if(ge<0||ge===1/0)return;pt.setup(k,H,ft,W,_t);let xe,ce=F;if(_t!==null&&(xe=X.get(_t),ce=dt,ce.setIndex(xe)),k.isMesh)H.wireframe===!0?(St.setLineWidth(H.wireframeLinewidth*Se()),ce.setMode(L.LINES)):ce.setMode(L.TRIANGLES);else if(k.isLine){let At=H.linewidth;At===void 0&&(At=1),St.setLineWidth(At*Se()),k.isLineSegments?ce.setMode(L.LINES):k.isLineLoop?ce.setMode(L.LINE_LOOP):ce.setMode(L.LINE_STRIP)}else k.isPoints?ce.setMode(L.POINTS):k.isSprite&&ce.setMode(L.TRIANGLES);if(k.isBatchedMesh)if(k._multiDrawInstances!==null)Ar("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ce.renderMultiDrawInstances(k._multiDrawStarts,k._multiDrawCounts,k._multiDrawCount,k._multiDrawInstances);else if(Jt.get("WEBGL_multi_draw"))ce.renderMultiDraw(k._multiDrawStarts,k._multiDrawCounts,k._multiDrawCount);else{const At=k._multiDrawStarts,re=k._multiDrawCounts,$t=k._multiDrawCount,en=_t?X.get(_t).bytesPerElement:1,Ti=v.get(H).currentProgram.getUniforms();for(let nn=0;nn<$t;nn++)Ti.setValue(L,"_gl_DrawID",nn),ce.render(At[nn]/en,re[nn])}else if(k.isInstancedMesh)ce.renderInstances(kt,ge,k.count);else if(W.isInstancedBufferGeometry){const At=W._maxInstanceCount!==void 0?W._maxInstanceCount:1/0,re=Math.min(W.instanceCount,At);ce.renderInstances(kt,ge,re)}else ce.render(kt,ge)};function Yo(y,B,W){y.transparent===!0&&y.side===An&&y.forceSinglePass===!1?(y.side=tn,y.needsUpdate=!0,Ur(y,B,W),y.side=ri,y.needsUpdate=!0,Ur(y,B,W),y.side=An):Ur(y,B,W)}this.compile=function(y,B,W=null){W===null&&(W=y),A=lt.get(W),A.init(B),R.push(A),W.traverseVisible(function(k){k.isLight&&k.layers.test(B.layers)&&(A.pushLight(k),k.castShadow&&A.pushShadow(k))}),y!==W&&y.traverseVisible(function(k){k.isLight&&k.layers.test(B.layers)&&(A.pushLight(k),k.castShadow&&A.pushShadow(k))}),A.setupLights();const H=new Set;return y.traverse(function(k){if(!(k.isMesh||k.isPoints||k.isLine||k.isSprite))return;const ct=k.material;if(ct)if(Array.isArray(ct))for(let mt=0;mt<ct.length;mt++){const ft=ct[mt];Yo(ft,W,k),H.add(ft)}else Yo(ct,W,k),H.add(ct)}),A=R.pop(),H},this.compileAsync=function(y,B,W=null){const H=this.compile(y,B,W);return new Promise(k=>{function ct(){if(H.forEach(function(mt){v.get(mt).currentProgram.isReady()&&H.delete(mt)}),H.size===0){k(y);return}setTimeout(ct,10)}Jt.get("KHR_parallel_shader_compile")!==null?ct():setTimeout(ct,10)})};let Vs=null;function vh(y){Vs&&Vs(y)}function qo(){ai.stop()}function jo(){ai.start()}const ai=new nh;ai.setAnimationLoop(vh),typeof self<"u"&&ai.setContext(self),this.setAnimationLoop=function(y){Vs=y,st.setAnimationLoop(y),y===null?ai.stop():ai.start()},st.addEventListener("sessionstart",qo),st.addEventListener("sessionend",jo),this.render=function(y,B){if(B!==void 0&&B.isCamera!==!0){Xt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(M===!0)return;const W=st.enabled===!0&&st.isPresenting===!0,H=P!==null&&(U===null||W)&&P.begin(g,U);if(y.matrixWorldAutoUpdate===!0&&y.updateMatrixWorld(),B.parent===null&&B.matrixWorldAutoUpdate===!0&&B.updateMatrixWorld(),st.enabled===!0&&st.isPresenting===!0&&(P===null||P.isCompositing()===!1)&&(st.cameraAutoUpdate===!0&&st.updateCamera(B),B=st.getCamera()),y.isScene===!0&&y.onBeforeRender(g,y,B,U),A=lt.get(y,R.length),A.init(B),R.push(A),Le.multiplyMatrices(B.projectionMatrix,B.matrixWorldInverse),Ut.setFromProjectionMatrix(Le,Rn,B.reversedDepth),jt=this.localClippingEnabled,vt=gt.init(this.clippingPlanes,jt),b=tt.get(y,C.length),b.init(),C.push(b),st.enabled===!0&&st.isPresenting===!0){const mt=g.xr.getDepthSensingMesh();mt!==null&&Gs(mt,B,-1/0,g.sortObjects)}Gs(y,B,0,g.sortObjects),b.finish(),g.sortObjects===!0&&b.sort(Kt,ee),Bt=st.enabled===!1||st.isPresenting===!1||st.hasDepthSensing()===!1,Bt&&ot.addToRenderList(b,y),this.info.render.frame++,vt===!0&&gt.beginShadows();const k=A.state.shadowsArray;if(yt.render(k,y,B),vt===!0&&gt.endShadows(),this.info.autoReset===!0&&this.info.reset(),(H&&P.hasRenderPass())===!1){const mt=b.opaque,ft=b.transmissive;if(A.setupLights(),B.isArrayCamera){const _t=B.cameras;if(ft.length>0)for(let bt=0,Rt=_t.length;bt<Rt;bt++){const Tt=_t[bt];Zo(mt,ft,y,Tt)}Bt&&ot.render(y);for(let bt=0,Rt=_t.length;bt<Rt;bt++){const Tt=_t[bt];$o(b,y,Tt,Tt.viewport)}}else ft.length>0&&Zo(mt,ft,y,B),Bt&&ot.render(y),$o(b,y,B)}U!==null&&I===0&&(O.updateMultisampleRenderTarget(U),O.updateRenderTargetMipmap(U)),H&&P.end(g),y.isScene===!0&&y.onAfterRender(g,y,B),pt.resetDefaultState(),z=-1,V=null,R.pop(),R.length>0?(A=R[R.length-1],vt===!0&&gt.setGlobalState(g.clippingPlanes,A.state.camera)):A=null,C.pop(),C.length>0?b=C[C.length-1]:b=null};function Gs(y,B,W,H){if(y.visible===!1)return;if(y.layers.test(B.layers)){if(y.isGroup)W=y.renderOrder;else if(y.isLOD)y.autoUpdate===!0&&y.update(B);else if(y.isLight)A.pushLight(y),y.castShadow&&A.pushShadow(y);else if(y.isSprite){if(!y.frustumCulled||Ut.intersectsSprite(y)){H&&ne.setFromMatrixPosition(y.matrixWorld).applyMatrix4(Le);const mt=at.update(y),ft=y.material;ft.visible&&b.push(y,mt,ft,W,ne.z,null)}}else if((y.isMesh||y.isLine||y.isPoints)&&(!y.frustumCulled||Ut.intersectsObject(y))){const mt=at.update(y),ft=y.material;if(H&&(y.boundingSphere!==void 0?(y.boundingSphere===null&&y.computeBoundingSphere(),ne.copy(y.boundingSphere.center)):(mt.boundingSphere===null&&mt.computeBoundingSphere(),ne.copy(mt.boundingSphere.center)),ne.applyMatrix4(y.matrixWorld).applyMatrix4(Le)),Array.isArray(ft)){const _t=mt.groups;for(let bt=0,Rt=_t.length;bt<Rt;bt++){const Tt=_t[bt],kt=ft[Tt.materialIndex];kt&&kt.visible&&b.push(y,mt,kt,W,ne.z,Tt)}}else ft.visible&&b.push(y,mt,ft,W,ne.z,null)}}const ct=y.children;for(let mt=0,ft=ct.length;mt<ft;mt++)Gs(ct[mt],B,W,H)}function $o(y,B,W,H){const{opaque:k,transmissive:ct,transparent:mt}=y;A.setupLightsView(W),vt===!0&&gt.setGlobalState(g.clippingPlanes,W),H&&St.viewport(G.copy(H)),k.length>0&&Lr(k,B,W),ct.length>0&&Lr(ct,B,W),mt.length>0&&Lr(mt,B,W),St.buffers.depth.setTest(!0),St.buffers.depth.setMask(!0),St.buffers.color.setMask(!0),St.setPolygonOffset(!1)}function Zo(y,B,W,H){if((W.isScene===!0?W.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[H.id]===void 0){const kt=Jt.has("EXT_color_buffer_half_float")||Jt.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[H.id]=new Pn(1,1,{generateMipmaps:!0,type:kt?Wn:Ge,minFilter:vi,samples:ue.samples,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Yt.workingColorSpace})}const ct=A.state.transmissionRenderTarget[H.id],mt=H.viewport||G;ct.setSize(mt.z*g.transmissionResolutionScale,mt.w*g.transmissionResolutionScale);const ft=g.getRenderTarget(),_t=g.getActiveCubeFace(),bt=g.getActiveMipmapLevel();g.setRenderTarget(ct),g.getClearColor(J),et=g.getClearAlpha(),et<1&&g.setClearColor(16777215,.5),g.clear(),Bt&&ot.render(W);const Rt=g.toneMapping;g.toneMapping=Cn;const Tt=H.viewport;if(H.viewport!==void 0&&(H.viewport=void 0),A.setupLightsView(H),vt===!0&&gt.setGlobalState(g.clippingPlanes,H),Lr(y,W,H),O.updateMultisampleRenderTarget(ct),O.updateRenderTargetMipmap(ct),Jt.has("WEBGL_multisampled_render_to_texture")===!1){let kt=!1;for(let ae=0,ge=B.length;ae<ge;ae++){const xe=B[ae],{object:ce,geometry:At,material:re,group:$t}=xe;if(re.side===An&&ce.layers.test(H.layers)){const en=re.side;re.side=tn,re.needsUpdate=!0,Ko(ce,W,H,At,re,$t),re.side=en,re.needsUpdate=!0,kt=!0}}kt===!0&&(O.updateMultisampleRenderTarget(ct),O.updateRenderTargetMipmap(ct))}g.setRenderTarget(ft,_t,bt),g.setClearColor(J,et),Tt!==void 0&&(H.viewport=Tt),g.toneMapping=Rt}function Lr(y,B,W){const H=B.isScene===!0?B.overrideMaterial:null;for(let k=0,ct=y.length;k<ct;k++){const mt=y[k],{object:ft,geometry:_t,group:bt}=mt;let Rt=mt.material;Rt.allowOverride===!0&&H!==null&&(Rt=H),ft.layers.test(W.layers)&&Ko(ft,B,W,_t,Rt,bt)}}function Ko(y,B,W,H,k,ct){y.onBeforeRender(g,B,W,H,k,ct),y.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,y.matrixWorld),y.normalMatrix.getNormalMatrix(y.modelViewMatrix),k.onBeforeRender(g,B,W,H,y,ct),k.transparent===!0&&k.side===An&&k.forceSinglePass===!1?(k.side=tn,k.needsUpdate=!0,g.renderBufferDirect(W,B,H,k,y,ct),k.side=ri,k.needsUpdate=!0,g.renderBufferDirect(W,B,H,k,y,ct),k.side=An):g.renderBufferDirect(W,B,H,k,y,ct),y.onAfterRender(g,B,W,H,k,ct)}function Ur(y,B,W){B.isScene!==!0&&(B=le);const H=v.get(y),k=A.state.lights,ct=A.state.shadowsArray,mt=k.state.version,ft=Mt.getParameters(y,k.state,ct,B,W),_t=Mt.getProgramCacheKey(ft);let bt=H.programs;H.environment=y.isMeshStandardMaterial?B.environment:null,H.fog=B.fog,H.envMap=(y.isMeshStandardMaterial?Z:q).get(y.envMap||H.environment),H.envMapRotation=H.environment!==null&&y.envMap===null?B.environmentRotation:y.envMapRotation,bt===void 0&&(y.addEventListener("dispose",Sn),bt=new Map,H.programs=bt);let Rt=bt.get(_t);if(Rt!==void 0){if(H.currentProgram===Rt&&H.lightsStateVersion===mt)return Qo(y,ft),Rt}else ft.uniforms=Mt.getUniforms(y),y.onBeforeCompile(ft,g),Rt=Mt.acquireProgram(ft,_t),bt.set(_t,Rt),H.uniforms=ft.uniforms;const Tt=H.uniforms;return(!y.isShaderMaterial&&!y.isRawShaderMaterial||y.clipping===!0)&&(Tt.clippingPlanes=gt.uniform),Qo(y,ft),H.needsLights=yh(y),H.lightsStateVersion=mt,H.needsLights&&(Tt.ambientLightColor.value=k.state.ambient,Tt.lightProbe.value=k.state.probe,Tt.directionalLights.value=k.state.directional,Tt.directionalLightShadows.value=k.state.directionalShadow,Tt.spotLights.value=k.state.spot,Tt.spotLightShadows.value=k.state.spotShadow,Tt.rectAreaLights.value=k.state.rectArea,Tt.ltc_1.value=k.state.rectAreaLTC1,Tt.ltc_2.value=k.state.rectAreaLTC2,Tt.pointLights.value=k.state.point,Tt.pointLightShadows.value=k.state.pointShadow,Tt.hemisphereLights.value=k.state.hemi,Tt.directionalShadowMap.value=k.state.directionalShadowMap,Tt.directionalShadowMatrix.value=k.state.directionalShadowMatrix,Tt.spotShadowMap.value=k.state.spotShadowMap,Tt.spotLightMatrix.value=k.state.spotLightMatrix,Tt.spotLightMap.value=k.state.spotLightMap,Tt.pointShadowMap.value=k.state.pointShadowMap,Tt.pointShadowMatrix.value=k.state.pointShadowMatrix),H.currentProgram=Rt,H.uniformsList=null,Rt}function Jo(y){if(y.uniformsList===null){const B=y.currentProgram.getUniforms();y.uniformsList=_s.seqWithValue(B.seq,y.uniforms)}return y.uniformsList}function Qo(y,B){const W=v.get(y);W.outputColorSpace=B.outputColorSpace,W.batching=B.batching,W.batchingColor=B.batchingColor,W.instancing=B.instancing,W.instancingColor=B.instancingColor,W.instancingMorph=B.instancingMorph,W.skinning=B.skinning,W.morphTargets=B.morphTargets,W.morphNormals=B.morphNormals,W.morphColors=B.morphColors,W.morphTargetsCount=B.morphTargetsCount,W.numClippingPlanes=B.numClippingPlanes,W.numIntersection=B.numClipIntersection,W.vertexAlphas=B.vertexAlphas,W.vertexTangents=B.vertexTangents,W.toneMapping=B.toneMapping}function Mh(y,B,W,H,k){B.isScene!==!0&&(B=le),O.resetTextureUnits();const ct=B.fog,mt=H.isMeshStandardMaterial?B.environment:null,ft=U===null?g.outputColorSpace:U.isXRRenderTarget===!0?U.texture.colorSpace:Ji,_t=(H.isMeshStandardMaterial?Z:q).get(H.envMap||mt),bt=H.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,Rt=!!W.attributes.tangent&&(!!H.normalMap||H.anisotropy>0),Tt=!!W.morphAttributes.position,kt=!!W.morphAttributes.normal,ae=!!W.morphAttributes.color;let ge=Cn;H.toneMapped&&(U===null||U.isXRRenderTarget===!0)&&(ge=g.toneMapping);const xe=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,ce=xe!==void 0?xe.length:0,At=v.get(H),re=A.state.lights;if(vt===!0&&(jt===!0||y!==V)){const Xe=y===V&&H.id===z;gt.setState(H,y,Xe)}let $t=!1;H.version===At.__version?(At.needsLights&&At.lightsStateVersion!==re.state.version||At.outputColorSpace!==ft||k.isBatchedMesh&&At.batching===!1||!k.isBatchedMesh&&At.batching===!0||k.isBatchedMesh&&At.batchingColor===!0&&k.colorTexture===null||k.isBatchedMesh&&At.batchingColor===!1&&k.colorTexture!==null||k.isInstancedMesh&&At.instancing===!1||!k.isInstancedMesh&&At.instancing===!0||k.isSkinnedMesh&&At.skinning===!1||!k.isSkinnedMesh&&At.skinning===!0||k.isInstancedMesh&&At.instancingColor===!0&&k.instanceColor===null||k.isInstancedMesh&&At.instancingColor===!1&&k.instanceColor!==null||k.isInstancedMesh&&At.instancingMorph===!0&&k.morphTexture===null||k.isInstancedMesh&&At.instancingMorph===!1&&k.morphTexture!==null||At.envMap!==_t||H.fog===!0&&At.fog!==ct||At.numClippingPlanes!==void 0&&(At.numClippingPlanes!==gt.numPlanes||At.numIntersection!==gt.numIntersection)||At.vertexAlphas!==bt||At.vertexTangents!==Rt||At.morphTargets!==Tt||At.morphNormals!==kt||At.morphColors!==ae||At.toneMapping!==ge||At.morphTargetsCount!==ce)&&($t=!0):($t=!0,At.__version=H.version);let en=At.currentProgram;$t===!0&&(en=Ur(H,B,k));let Ti=!1,nn=!1,sr=!1;const de=en.getUniforms(),je=At.uniforms;if(St.useProgram(en.program)&&(Ti=!0,nn=!0,sr=!0),H.id!==z&&(z=H.id,nn=!0),Ti||V!==y){St.buffers.depth.getReversed()&&y.reversedDepth!==!0&&(y._reversedDepth=!0,y.updateProjectionMatrix()),de.setValue(L,"projectionMatrix",y.projectionMatrix),de.setValue(L,"viewMatrix",y.matrixWorldInverse);const $e=de.map.cameraPosition;$e!==void 0&&$e.setValue(L,Wt.setFromMatrixPosition(y.matrixWorld)),ue.logarithmicDepthBuffer&&de.setValue(L,"logDepthBufFC",2/(Math.log(y.far+1)/Math.LN2)),(H.isMeshPhongMaterial||H.isMeshToonMaterial||H.isMeshLambertMaterial||H.isMeshBasicMaterial||H.isMeshStandardMaterial||H.isShaderMaterial)&&de.setValue(L,"isOrthographic",y.isOrthographicCamera===!0),V!==y&&(V=y,nn=!0,sr=!0)}if(At.needsLights&&(re.state.directionalShadowMap.length>0&&de.setValue(L,"directionalShadowMap",re.state.directionalShadowMap,O),re.state.spotShadowMap.length>0&&de.setValue(L,"spotShadowMap",re.state.spotShadowMap,O),re.state.pointShadowMap.length>0&&de.setValue(L,"pointShadowMap",re.state.pointShadowMap,O)),k.isSkinnedMesh){de.setOptional(L,k,"bindMatrix"),de.setOptional(L,k,"bindMatrixInverse");const Xe=k.skeleton;Xe&&(Xe.boneTexture===null&&Xe.computeBoneTexture(),de.setValue(L,"boneTexture",Xe.boneTexture,O))}k.isBatchedMesh&&(de.setOptional(L,k,"batchingTexture"),de.setValue(L,"batchingTexture",k._matricesTexture,O),de.setOptional(L,k,"batchingIdTexture"),de.setValue(L,"batchingIdTexture",k._indirectTexture,O),de.setOptional(L,k,"batchingColorTexture"),k._colorsTexture!==null&&de.setValue(L,"batchingColorTexture",k._colorsTexture,O));const cn=W.morphAttributes;if((cn.position!==void 0||cn.normal!==void 0||cn.color!==void 0)&&zt.update(k,W,en),(nn||At.receiveShadow!==k.receiveShadow)&&(At.receiveShadow=k.receiveShadow,de.setValue(L,"receiveShadow",k.receiveShadow)),H.isMeshGouraudMaterial&&H.envMap!==null&&(je.envMap.value=_t,je.flipEnvMap.value=_t.isCubeTexture&&_t.isRenderTargetTexture===!1?-1:1),H.isMeshStandardMaterial&&H.envMap===null&&B.environment!==null&&(je.envMapIntensity.value=B.environmentIntensity),je.dfgLUT!==void 0&&(je.dfgLUT.value=e0()),nn&&(de.setValue(L,"toneMappingExposure",g.toneMappingExposure),At.needsLights&&Sh(je,sr),ct&&H.fog===!0&&Ct.refreshFogUniforms(je,ct),Ct.refreshMaterialUniforms(je,H,Lt,Dt,A.state.transmissionRenderTarget[y.id]),_s.upload(L,Jo(At),je,O)),H.isShaderMaterial&&H.uniformsNeedUpdate===!0&&(_s.upload(L,Jo(At),je,O),H.uniformsNeedUpdate=!1),H.isSpriteMaterial&&de.setValue(L,"center",k.center),de.setValue(L,"modelViewMatrix",k.modelViewMatrix),de.setValue(L,"normalMatrix",k.normalMatrix),de.setValue(L,"modelMatrix",k.matrixWorld),H.isShaderMaterial||H.isRawShaderMaterial){const Xe=H.uniformsGroups;for(let $e=0,Hs=Xe.length;$e<Hs;$e++){const oi=Xe[$e];Q.update(oi,en),Q.bind(oi,en)}}return en}function Sh(y,B){y.ambientLightColor.needsUpdate=B,y.lightProbe.needsUpdate=B,y.directionalLights.needsUpdate=B,y.directionalLightShadows.needsUpdate=B,y.pointLights.needsUpdate=B,y.pointLightShadows.needsUpdate=B,y.spotLights.needsUpdate=B,y.spotLightShadows.needsUpdate=B,y.rectAreaLights.needsUpdate=B,y.hemisphereLights.needsUpdate=B}function yh(y){return y.isMeshLambertMaterial||y.isMeshToonMaterial||y.isMeshPhongMaterial||y.isMeshStandardMaterial||y.isShadowMaterial||y.isShaderMaterial&&y.lights===!0}this.getActiveCubeFace=function(){return T},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return U},this.setRenderTargetTextures=function(y,B,W){const H=v.get(y);H.__autoAllocateDepthBuffer=y.resolveDepthBuffer===!1,H.__autoAllocateDepthBuffer===!1&&(H.__useRenderToTexture=!1),v.get(y.texture).__webglTexture=B,v.get(y.depthTexture).__webglTexture=H.__autoAllocateDepthBuffer?void 0:W,H.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(y,B){const W=v.get(y);W.__webglFramebuffer=B,W.__useDefaultFramebuffer=B===void 0};const Eh=L.createFramebuffer();this.setRenderTarget=function(y,B=0,W=0){U=y,T=B,I=W;let H=null,k=!1,ct=!1;if(y){const ft=v.get(y);if(ft.__useDefaultFramebuffer!==void 0){St.bindFramebuffer(L.FRAMEBUFFER,ft.__webglFramebuffer),G.copy(y.viewport),N.copy(y.scissor),Y=y.scissorTest,St.viewport(G),St.scissor(N),St.setScissorTest(Y),z=-1;return}else if(ft.__webglFramebuffer===void 0)O.setupRenderTarget(y);else if(ft.__hasExternalTextures)O.rebindTextures(y,v.get(y.texture).__webglTexture,v.get(y.depthTexture).__webglTexture);else if(y.depthBuffer){const Rt=y.depthTexture;if(ft.__boundDepthTexture!==Rt){if(Rt!==null&&v.has(Rt)&&(y.width!==Rt.image.width||y.height!==Rt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");O.setupDepthRenderbuffer(y)}}const _t=y.texture;(_t.isData3DTexture||_t.isDataArrayTexture||_t.isCompressedArrayTexture)&&(ct=!0);const bt=v.get(y).__webglFramebuffer;y.isWebGLCubeRenderTarget?(Array.isArray(bt[B])?H=bt[B][W]:H=bt[B],k=!0):y.samples>0&&O.useMultisampledRTT(y)===!1?H=v.get(y).__webglMultisampledFramebuffer:Array.isArray(bt)?H=bt[W]:H=bt,G.copy(y.viewport),N.copy(y.scissor),Y=y.scissorTest}else G.copy(j).multiplyScalar(Lt).floor(),N.copy(K).multiplyScalar(Lt).floor(),Y=rt;if(W!==0&&(H=Eh),St.bindFramebuffer(L.FRAMEBUFFER,H)&&St.drawBuffers(y,H),St.viewport(G),St.scissor(N),St.setScissorTest(Y),k){const ft=v.get(y.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+B,ft.__webglTexture,W)}else if(ct){const ft=B;for(let _t=0;_t<y.textures.length;_t++){const bt=v.get(y.textures[_t]);L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0+_t,bt.__webglTexture,W,ft)}}else if(y!==null&&W!==0){const ft=v.get(y.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,ft.__webglTexture,W)}z=-1},this.readRenderTargetPixels=function(y,B,W,H,k,ct,mt,ft=0){if(!(y&&y.isWebGLRenderTarget)){Xt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let _t=v.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&mt!==void 0&&(_t=_t[mt]),_t){St.bindFramebuffer(L.FRAMEBUFFER,_t);try{const bt=y.textures[ft],Rt=bt.format,Tt=bt.type;if(!ue.textureFormatReadable(Rt)){Xt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ue.textureTypeReadable(Tt)){Xt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}B>=0&&B<=y.width-H&&W>=0&&W<=y.height-k&&(y.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+ft),L.readPixels(B,W,H,k,nt.convert(Rt),nt.convert(Tt),ct))}finally{const bt=U!==null?v.get(U).__webglFramebuffer:null;St.bindFramebuffer(L.FRAMEBUFFER,bt)}}},this.readRenderTargetPixelsAsync=async function(y,B,W,H,k,ct,mt,ft=0){if(!(y&&y.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let _t=v.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&mt!==void 0&&(_t=_t[mt]),_t)if(B>=0&&B<=y.width-H&&W>=0&&W<=y.height-k){St.bindFramebuffer(L.FRAMEBUFFER,_t);const bt=y.textures[ft],Rt=bt.format,Tt=bt.type;if(!ue.textureFormatReadable(Rt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ue.textureTypeReadable(Tt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const kt=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,kt),L.bufferData(L.PIXEL_PACK_BUFFER,ct.byteLength,L.STREAM_READ),y.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+ft),L.readPixels(B,W,H,k,nt.convert(Rt),nt.convert(Tt),0);const ae=U!==null?v.get(U).__webglFramebuffer:null;St.bindFramebuffer(L.FRAMEBUFFER,ae);const ge=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);return L.flush(),await Su(L,ge,4),L.bindBuffer(L.PIXEL_PACK_BUFFER,kt),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,ct),L.deleteBuffer(kt),L.deleteSync(ge),ct}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(y,B=null,W=0){const H=Math.pow(2,-W),k=Math.floor(y.image.width*H),ct=Math.floor(y.image.height*H),mt=B!==null?B.x:0,ft=B!==null?B.y:0;O.setTexture2D(y,0),L.copyTexSubImage2D(L.TEXTURE_2D,W,0,0,mt,ft,k,ct),St.unbindTexture()};const bh=L.createFramebuffer(),Th=L.createFramebuffer();this.copyTextureToTexture=function(y,B,W=null,H=null,k=0,ct=null){ct===null&&(k!==0?(Ar("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ct=k,k=0):ct=0);let mt,ft,_t,bt,Rt,Tt,kt,ae,ge;const xe=y.isCompressedTexture?y.mipmaps[ct]:y.image;if(W!==null)mt=W.max.x-W.min.x,ft=W.max.y-W.min.y,_t=W.isBox3?W.max.z-W.min.z:1,bt=W.min.x,Rt=W.min.y,Tt=W.isBox3?W.min.z:0;else{const cn=Math.pow(2,-k);mt=Math.floor(xe.width*cn),ft=Math.floor(xe.height*cn),y.isDataArrayTexture?_t=xe.depth:y.isData3DTexture?_t=Math.floor(xe.depth*cn):_t=1,bt=0,Rt=0,Tt=0}H!==null?(kt=H.x,ae=H.y,ge=H.z):(kt=0,ae=0,ge=0);const ce=nt.convert(B.format),At=nt.convert(B.type);let re;B.isData3DTexture?(O.setTexture3D(B,0),re=L.TEXTURE_3D):B.isDataArrayTexture||B.isCompressedArrayTexture?(O.setTexture2DArray(B,0),re=L.TEXTURE_2D_ARRAY):(O.setTexture2D(B,0),re=L.TEXTURE_2D),L.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,B.flipY),L.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,B.premultiplyAlpha),L.pixelStorei(L.UNPACK_ALIGNMENT,B.unpackAlignment);const $t=L.getParameter(L.UNPACK_ROW_LENGTH),en=L.getParameter(L.UNPACK_IMAGE_HEIGHT),Ti=L.getParameter(L.UNPACK_SKIP_PIXELS),nn=L.getParameter(L.UNPACK_SKIP_ROWS),sr=L.getParameter(L.UNPACK_SKIP_IMAGES);L.pixelStorei(L.UNPACK_ROW_LENGTH,xe.width),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,xe.height),L.pixelStorei(L.UNPACK_SKIP_PIXELS,bt),L.pixelStorei(L.UNPACK_SKIP_ROWS,Rt),L.pixelStorei(L.UNPACK_SKIP_IMAGES,Tt);const de=y.isDataArrayTexture||y.isData3DTexture,je=B.isDataArrayTexture||B.isData3DTexture;if(y.isDepthTexture){const cn=v.get(y),Xe=v.get(B),$e=v.get(cn.__renderTarget),Hs=v.get(Xe.__renderTarget);St.bindFramebuffer(L.READ_FRAMEBUFFER,$e.__webglFramebuffer),St.bindFramebuffer(L.DRAW_FRAMEBUFFER,Hs.__webglFramebuffer);for(let oi=0;oi<_t;oi++)de&&(L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,v.get(y).__webglTexture,k,Tt+oi),L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,v.get(B).__webglTexture,ct,ge+oi)),L.blitFramebuffer(bt,Rt,mt,ft,kt,ae,mt,ft,L.DEPTH_BUFFER_BIT,L.NEAREST);St.bindFramebuffer(L.READ_FRAMEBUFFER,null),St.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else if(k!==0||y.isRenderTargetTexture||v.has(y)){const cn=v.get(y),Xe=v.get(B);St.bindFramebuffer(L.READ_FRAMEBUFFER,bh),St.bindFramebuffer(L.DRAW_FRAMEBUFFER,Th);for(let $e=0;$e<_t;$e++)de?L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,cn.__webglTexture,k,Tt+$e):L.framebufferTexture2D(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,cn.__webglTexture,k),je?L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,Xe.__webglTexture,ct,ge+$e):L.framebufferTexture2D(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,Xe.__webglTexture,ct),k!==0?L.blitFramebuffer(bt,Rt,mt,ft,kt,ae,mt,ft,L.COLOR_BUFFER_BIT,L.NEAREST):je?L.copyTexSubImage3D(re,ct,kt,ae,ge+$e,bt,Rt,mt,ft):L.copyTexSubImage2D(re,ct,kt,ae,bt,Rt,mt,ft);St.bindFramebuffer(L.READ_FRAMEBUFFER,null),St.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else je?y.isDataTexture||y.isData3DTexture?L.texSubImage3D(re,ct,kt,ae,ge,mt,ft,_t,ce,At,xe.data):B.isCompressedArrayTexture?L.compressedTexSubImage3D(re,ct,kt,ae,ge,mt,ft,_t,ce,xe.data):L.texSubImage3D(re,ct,kt,ae,ge,mt,ft,_t,ce,At,xe):y.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,ct,kt,ae,mt,ft,ce,At,xe.data):y.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,ct,kt,ae,xe.width,xe.height,ce,xe.data):L.texSubImage2D(L.TEXTURE_2D,ct,kt,ae,mt,ft,ce,At,xe);L.pixelStorei(L.UNPACK_ROW_LENGTH,$t),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,en),L.pixelStorei(L.UNPACK_SKIP_PIXELS,Ti),L.pixelStorei(L.UNPACK_SKIP_ROWS,nn),L.pixelStorei(L.UNPACK_SKIP_IMAGES,sr),ct===0&&B.generateMipmaps&&L.generateMipmap(re),St.unbindTexture()},this.initRenderTarget=function(y){v.get(y).__webglFramebuffer===void 0&&O.setupRenderTarget(y)},this.initTexture=function(y){y.isCubeTexture?O.setTextureCube(y,0):y.isData3DTexture?O.setTexture3D(y,0):y.isDataArrayTexture||y.isCompressedArrayTexture?O.setTexture2DArray(y,0):O.setTexture2D(y,0),St.unbindTexture()},this.resetState=function(){T=0,I=0,U=null,St.reset(),pt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Rn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=Yt._getDrawingBufferColorSpace(t),e.unpackColorSpace=Yt._getUnpackColorSpace()}}const oh=10,lh=1<<oh,Oe=3,on=1<<Oe,Ea=on-1,gs=oh-Oe,Zt=1<<gs,xt=on+2,Ht=9,Gt=1<<Ht,Nt=Math.floor(Gt/xt),oc=Nt*Nt*Nt,i0=Zt*Zt*Zt*4,bn=10,r0=(lh>>1)*bn;class Ho{indirectionData=new Uint8Array(i0);atlasData=new Uint8Array(Gt**3);colourData=new Uint8Array(Gt**3*4);freeBricks=[];brickMap=new Map;dirtyColourBricks=new Set;constructor(){for(let t=0;t<oc;t++)this.freeBricks.push(t)}async load(t){await t.read(this.indirectionData,0,this.indirectionData.length);let e=new Set;this.brickMap.clear();let n=new Uint8Array(xt**3);for(let r=0,s=0;r<this.indirectionData.length;r+=4,++s){let a=this.indirectionData[r],o=this.indirectionData[r+1],l=this.indirectionData[r+2];if(this.indirectionData[r+3]==255){let f=l*(Nt*Nt)+o*Nt+a;this.brickMap.set(s,f),e.add(f),await t.read(n,0,n.length);let d=l*xt<<Ht+Ht|o*xt<<Ht|a*xt,h=1,p=1<<Ht,_=1<<Ht+Ht,x=0;for(let m=0;m<xt;++m,d+=_){let u=d;for(let S=0;S<xt;++S,u+=p){let E=u;for(let b=0;b<xt;++b,E+=h)this.atlasData[E]=n[x++]}}}}this.freeBricks.splice(0,this.freeBricks.length);for(let r=0;r<oc;++r)e.has(r)||this.freeBricks.push(r)}async save(t){await t.write(this.indirectionData);let e=new Uint8Array(xt**3);for(let n=0,r=0;n<this.indirectionData.length;n+=4,++r){let s=this.indirectionData[n],a=this.indirectionData[n+1],o=this.indirectionData[n+2];if(this.indirectionData[n+3]==255){let c=o*xt<<Ht+Ht|a*xt<<Ht|s*xt,f=1,d=1<<Ht,h=1<<Ht+Ht,p=0;for(let _=0;_<xt;++_,c+=h){let x=c;for(let m=0;m<xt;++m,x+=d){let u=x;for(let S=0;S<xt;++S,u+=f)e[p++]=this.atlasData[u]}}await t.write(e)}}}getGridIdx(t,e,n){return n*Zt*Zt+e*Zt+t}copy(t){for(let e=0;e<this.indirectionData.length;++e)this.indirectionData[e]=t.indirectionData[e];for(let e=0;e<this.atlasData.length;++e)this.atlasData[e]=t.atlasData[e];this.freeBricks.splice(0,this.freeBricks.length);for(let e=0;e<t.freeBricks.length;++e)this.freeBricks.push(t.freeBricks[e]);this.brickMap.clear();for(let e of t.brickMap)this.brickMap.set(e[0],e[1]);return this}get(t,e,n){const r=t>>Oe,s=e>>Oe,a=n>>Oe,o=this.getGridIdx(r,s,a);let l=this.brickMap.get(o);if(l==null)return this.indirectionData[o*4+3]>=128?255:0;const c=l%Nt,f=Math.floor(l/Nt)%Nt,d=Math.floor(l/(Nt*Nt)),h=(t&Ea)+1,p=(e&Ea)+1,_=(n&Ea)+1,x=(d*xt+_)*Gt*Gt+(f*xt+p)*Gt+(c*xt+h);return this.atlasData[x]}_set_collapse={allPositive:!1,allNegative:!1};set(t,e,n,r){const s=t-1>>Oe,a=t+1>>Oe,o=e-1>>Oe,l=e+1>>Oe,c=n-1>>Oe,f=n+1>>Oe;for(let d=c;d<=f;d++)for(let h=o;h<=l;h++)for(let p=s;p<=a;p++){if(p<0||p>=Zt||h<0||h>=Zt||d<0||d>=Zt)continue;const _=this.getGridIdx(p,h,d),x=t-p*on+1,m=e-h*on+1,u=n-d*on+1;if(!(x<0||x>=xt||m<0||m>=xt||u<0||u>=xt)&&(this.ensureBrickAllocated(p,h,d),this.brickMap.has(_))){const S=this.brickMap.get(_);let E=x==xt-1&&m==xt-1&&u==xt-1;if(this.writeToAtlas(S,x,m,u,r,E,this._set_collapse),E){let b=this._set_collapse.allPositive,A=this._set_collapse.allNegative;(b||A)&&this.deallocateBrick(_,A)}}}}paint(t,e,n,r,s,a){r=255-r,s=255-s,a=255-a;const o=t-1>>Oe,l=t+1>>Oe,c=e-1>>Oe,f=e+1>>Oe,d=n-1>>Oe,h=n+1>>Oe;for(let p=d;p<=h;p++)for(let _=c;_<=f;_++)for(let x=o;x<=l;x++){if(x<0||x>=Zt||_<0||_>=Zt||p<0||p>=Zt)continue;const m=this.getGridIdx(x,_,p),u=t-x*on+1,S=e-_*on+1,E=n-p*on+1;if(!(u<0||u>=xt||S<0||S>=xt||E<0||E>=xt)&&this.brickMap.has(m)){let b=this.brickMap.get(m),A=b%Nt,C=Math.floor(b/Nt)%Nt,g=(Math.floor(b/(Nt*Nt))*xt+E)*Gt*Gt+(C*xt+S)*Gt+(A*xt+u)<<2;this.colourData[g]=r,this.colourData[g+1]=s,this.colourData[g+2]=a,this.colourData[g+3]=255,this.dirtyColourBricks.add(b)}}}_march_tmpV3_1=new D;march(t,e,n){n[0]=0;for(let o=0;o<200;++o){let l=this._march_tmpV3_1.copy(e).multiplyScalar(n[0]).add(t),c=this.map(l,e);if(c<5)return!0;if(n[0]+=c,n[0]>1e4)break}return!1}_map_tmpV3_1=new D;_map_tmpV3_2=new D;_map_tmpV3_3=new D;_map_tmpV3_4=new D;_map_tmpV3_5=new D;_map_tmpV3_6=new D;_map_tmpV3_7=new D;_map_tmpV3_8=new D;_map_tmpV4_1=new _e;map(t,e){let n=this._map_tmpV3_1.copy(t).addScalar(r0),r=this._map_tmpV3_2.copy(n).multiplyScalar(1/(Zt*on*bn)),s=this._map_tmpV4_1;this.readIndirectionTexture01(r,s);let a=this._map_tmpV3_3.copy(r).multiplyScalar(Zt);if(a.set(a.x-Math.floor(a.x),a.y-Math.floor(a.y),a.z-Math.floor(a.z)),s.w==0){let d=this._map_tmpV3_4.copy(a).subScalar(.5),h=this._map_tmpV3_5.copy(e);h.x=1/h.x,h.y=1/h.y,h.z=1/h.z;let p=this._map_tmpV3_6.copy(d).multiply(h),_=this._map_tmpV3_7.copy(h).multiplyScalar(.5);_.x=Math.abs(_.x),_.y=Math.abs(_.y),_.z=Math.abs(_.z);let x=this._map_tmpV3_8.copy(p).negate().add(_),m=Math.min(x.x,x.y,x.z);return Math.max(bn,m*(on*bn))}let o=this._map_tmpV3_4.copy(s).multiplyScalar(2550),l=this._map_tmpV3_5.copy(o).addScalar(1).add(this._map_tmpV3_6.copy(a).multiplyScalar(8)),c=this._map_tmpV3_6.copy(l).divideScalar(Gt);return(.5-this.readAtlasTexture01(c))*2*bn}readIndirectionTexture01(t,e){let n=Math.max(0,Math.min(Zt-1,Math.floor(t.x*Zt))),r=Math.max(0,Math.min(Zt-1,Math.floor(t.y*Zt))),a=(Math.max(0,Math.min(Zt-1,Math.floor(t.z*Zt)))<<gs+gs|r<<gs|n)<<2;e.x=this.indirectionData[a+0]/255,e.y=this.indirectionData[a+1]/255,e.z=this.indirectionData[a+2]/255,e.w=this.indirectionData[a+3]/255}readAtlasTexture01(t){let e=Math.max(0,Math.min(Gt-1,Math.floor(t.x*Gt))),n=Math.max(0,Math.min(Gt-1,Math.floor(t.y*Gt))),r=Math.max(0,Math.min(Gt-1,Math.floor(t.z*Gt)));return this.atlasData[r<<Ht+Ht|n<<Ht|e]/255}ensureBrickAllocated(t,e,n){const r=this.getGridIdx(t,e,n);let s=this.indirectionData[(r<<2)+3];if(!this.brickMap.has(r)){const a=this.freeBricks.pop();if(a===void 0)return;if(s==128){const l=a%Nt,c=Math.floor(a/Nt)%Nt;let d=Math.floor(a/(Nt*Nt))*xt<<Ht+Ht|c*xt<<Ht|l*xt,h=1,p=1<<Ht,_=1<<Ht+Ht;for(let x=0;x<xt;++x,d+=_){let m=d;for(let u=0;u<xt;++u,m+=p){let S=m;for(let E=0;E<xt;++E,S+=h)this.atlasData[S]=255}}}this.brickMap.set(r,a);const o=r*4;this.indirectionData[o]=a%Nt,this.indirectionData[o+1]=Math.floor(a/Nt)%Nt,this.indirectionData[o+2]=Math.floor(a/(Nt*Nt)),this.indirectionData[o+3]=255}}deallocateBrick(t,e){let n=this.brickMap.get(t);if(n!=null){this.brickMap.delete(t),this.freeBricks.push(n);let r=t<<2;this.indirectionData[r+3]=e?128:0;const s=n%Nt,a=Math.floor(n/Nt)%Nt;let l=Math.floor(n/(Nt*Nt))*xt<<Ht+Ht|a*xt<<Ht|s*xt,c=1,f=1<<Ht,d=1<<Ht+Ht;for(let h=0;h<xt;++h,l+=d){let p=l;for(let _=0;_<xt;++_,p+=f){let x=p;for(let m=0;m<xt;++m,x+=c)this.atlasData[x]=0}}}}writeToAtlas(t,e,n,r,s,a,o){const l=t%Nt,c=Math.floor(t/Nt)%Nt,f=Math.floor(t/(Nt*Nt)),d=(f*xt+r)*Gt*Gt+(c*xt+n)*Gt+(l*xt+e);if(this.atlasData[d]=s,a){let h=f*xt<<Ht+Ht|c*xt<<Ht|l*xt,p=1,_=1<<Ht,x=1<<Ht+Ht,m=!0,u=!0;t:for(let S=0;S<xt;++S,h+=x){let E=h;for(let b=0;b<xt;++b,E+=_){let A=E;for(let C=0;C<xt;++C,A+=p){let R=this.atlasData[A];if(R<128&&(u=!1,!m)||R>128&&(m=!1,!u))break t}}}o.allPositive=m,o.allNegative=u}}initTexturesThreeJs(t){let e=t.uniforms;e==null&&(e={},t.uniforms=e);let n=new ms(this.indirectionData,Zt,Zt,Zt);n.format=ln,n.type=Ge,n.minFilter=Ce,n.magFilter=Ce,n.wrapS=Ne,n.wrapT=Ne,n.wrapR=Ne,n.unpackAlignment=1,n.needsUpdate=!0;let r=new ms(this.atlasData,Gt,Gt,Gt);r.format=Io,r.type=Ge,r.minFilter=be,r.magFilter=be,r.wrapS=Ne,r.wrapT=Ne,r.wrapR=Ne,r.unpackAlignment=1,r.needsUpdate=!0;let s=new ms(this.colourData,Gt,Gt,Gt);return s.format=ln,s.type=Ge,s.minFilter=be,s.magFilter=be,s.wrapS=Ne,s.wrapT=Ne,s.wrapR=Ne,s.unpackAlignment=1,s.needsUpdate=!0,e.uIndirectionTex={value:n},e.uAtlasTex={value:r},e.uColourTex={value:s},{iTex:n,aTex:r,cTex:s}}updateTexturesThreeJs(t){t.iTex.needsUpdate=!0,t.aTex.needsUpdate=!0}tempColourDataBuffer=new Uint8Array(xt**3<<2);updatePaintThreeJs(t,e){const n=t.getContext();let r=t.properties.get(e.cTex);if(!r.__webglTexture){e.cTex.needsUpdate=!0,this.dirtyColourBricks.clear();return}n.bindTexture(n.TEXTURE_3D,r.__webglTexture);for(let s of this.dirtyColourBricks){let a=s%Nt,o=Math.floor(s/Nt)%Nt,l=Math.floor(s/(Nt*Nt));const c=a*xt,f=o*xt,d=l*xt;let h=0;for(let p=0;p<xt;p++){let _=(d+p)*Gt*Gt+f*Gt+c<<2;for(let x=0;x<xt;x++){let m=_+(x*Gt<<2);for(let u=0;u<xt;u++){let S=m+(u<<2);this.tempColourDataBuffer[h++]=this.colourData[S],this.tempColourDataBuffer[h++]=this.colourData[S+1],this.tempColourDataBuffer[h++]=this.colourData[S+2],this.tempColourDataBuffer[h++]=this.colourData[S+3]}}}n.texSubImage3D(n.TEXTURE_3D,0,c,f,d,xt,xt,xt,n.RGBA,n.UNSIGNED_BYTE,this.tempColourDataBuffer)}this.dirtyColourBricks.clear()}initTextures(t,e){let n=t.getUniformLocation(e,"uIndirectionTex"),r=t.getUniformLocation(e,"uAtlasTex");t.uniform1i(n,0),t.uniform1i(r,1),t.activeTexture(t.TEXTURE0);const s=t.createTexture();t.bindTexture(t.TEXTURE_3D,s),t.texImage3D(t.TEXTURE_3D,0,t.RGBA8,Zt,Zt,Zt,0,t.RGBA,t.UNSIGNED_BYTE,this.indirectionData),t.texParameteri(t.TEXTURE_3D,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(t.TEXTURE_3D,t.TEXTURE_MAG_FILTER,t.NEAREST),t.texParameteri(t.TEXTURE_3D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_3D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_3D,t.TEXTURE_WRAP_R,t.CLAMP_TO_EDGE),t.activeTexture(t.TEXTURE1);const a=t.createTexture();return t.bindTexture(t.TEXTURE_3D,a),t.texImage3D(t.TEXTURE_3D,0,t.R8,Gt,Gt,Gt,0,t.RED,t.UNSIGNED_BYTE,this.atlasData),t.texParameteri(t.TEXTURE_3D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_3D,t.TEXTURE_MAG_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_3D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_3D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_3D,t.TEXTURE_WRAP_R,t.CLAMP_TO_EDGE),{iTex:s,aTex:a}}updateTextures(t,e){t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_3D,e.iTex),t.texSubImage3D(t.TEXTURE_3D,0,0,0,0,Zt,Zt,Zt,t.RGBA,t.UNSIGNED_BYTE,this.indirectionData),t.activeTexture(t.TEXTURE1),t.bindTexture(t.TEXTURE_3D,e.aTex),t.texSubImage3D(t.TEXTURE_3D,0,0,0,0,Gt,Gt,Gt,t.RED,t.UNSIGNED_BYTE,this.atlasData)}writeShaderCode(){return`uniform sampler3D uIndirectionTex;
...
const float ATLAS_RES = ${Gt.toFixed(1)};
